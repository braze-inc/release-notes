...
- Standard attributes can also be set as long as they match the [standard user profile](https://www.braze.com/docs/api/endpoints/user_data/#braze-user-profile-fields) names exactly.
