...
| Braze | A Braze REST endpoint | Your REST endpoint URL. Your endpoint will depend on the Braze URL for [your instance](https://www.braze.com/docs/api/basics/#endpoints). |
...
If you are using the [older navigation](https://www.braze.com/docs/user_guide/administer/personal/the_braze_dashboard/), you can create an API key at **Developer Console** > **API Settings**. 
...
![Segment Builder with the "Custom Attributes" filter selected.](https://www.braze.com/docs/assets/img/sessionm/CreateSegment.png?2e5d7ee041e08d51c77693c912a3bde1)
...
![Webhook settings.](https://www.braze.com/docs/assets/img/sessionm/SessionMWebhookSettings.png?90b69cefc5589409a52954adbc72b698){: style="max-width:85%;"}
...
In campaign or Canvas step with the SessionM offers, use [Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/making_an_api_call/) to make an API call to the [SessionM `get_user_offers` endpoint](https://domains-connecteast1.ent-sessionm.com/offers/swagger/ui/index#!_GetUserOffers/).
...
![API trigger properties.](https://www.braze.com/docs/assets/img/sessionm/apiTriggerProperties.png?642735a749a9463a14059e6d9e10f668)
...
![API triggered campaign.](https://www.braze.com/docs/assets/img/sessionm/apiTriggerCampaign.png?cfc526cb28d908ced2b37d6faa84f19a)
...
![SessionM Campaign Creation.](https://www.braze.com/docs/assets/img/sessionm/SessionMCampaignCreation.png?4993439738aa8746a3f4399b0d5cead2)
...
![SessionM advanced settings.](https://www.braze.com/docs/assets/img/sessionm/SessionMAdvancedSettings.png?0057d96711af8540e6d1b74c7015180f){: style="max-width:85%;"}
...
![SessionM external message.](https://www.braze.com/docs/assets/img/sessionm/SessionMExternalMessage.png?ece65b3fda63e21f52ba05cf1b35f2b7)

This template pulls the relevant static and dynamic attributes and call out to the Braze endpoint.

![SessionM Braze template.](https://www.braze.com/docs/assets/img/sessionm/SessionMBrazeTemplate.png?ea6bae926de3d95d9a5ecee92809b1dc){: style="max-width:85%;"}
