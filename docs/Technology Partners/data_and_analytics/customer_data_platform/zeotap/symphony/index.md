...
| Instance | Your Braze instance can be obtained from your Braze onboarding manager or can be found on the [API overview page](https://www.braze.com/docs/api/basics/#endpoints). |
...
The data will flow from Zeotap to Braze using the [`/users/track` endpoint](https://www.braze.com/docs/api/endpoints/user_data/post_user_track/). The following points summarize the data flow:
...
- **Dropdown Selection** - Map the relevant fields ingested in Zeotap to the Braze fields provided in the dropdown menu.<br>![Various user traits set in Zeotap, such as language, city, birthday, and more.](https://www.braze.com/docs/assets/img/zeotap/zeotap7.png?50ee07b9449c0a62f05968691dee1211){: style="max-width:70%;"}<br>
- **Custom Data Input** - Add custom data mapped to the relevant Zeotap field and send to Braze.<br>![Selecting "loyalty_points" as the user trait in Zeotap.](https://www.braze.com/docs/assets/img/zeotap/zeotap8.png?503fb6b14ccbd19013d1243f552b5fe2){: style="max-width:70%;"}
...
{: .reset-td-br-1 .reset-td-br-2 .reset-td-br-3 .reset-td-br-4 aria-label="Supported attributes" }
...
![Braze user profile view showing incoming Zeotap attributes and events.](https://www.braze.com/docs/assets/img/zeotap/zeotap6.jpg?dbb1af83fbe8ed7481a3da2045726045)
