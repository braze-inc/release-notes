...
| Braze Data Transformation Endpoint| This integration relies on Braze's [Data Transformation Tool](https://www.braze.com/docs/user_guide/data/unification/data_transformation/). When you create a Data Transformation, Braze generates a unique endpoint that you can add as a destination for Crowdtwist's Data Push.|
{: .reset-td-br-1 .reset-td-br-2 aria-label="Prerequisites" }

## Integration

Braze and Oracle Crowdtwist have created [Data Transformation templates](https://www.braze.com/docs/user_guide/data/unification/data_transformation/creating_a_transformation?redirected=1#step-2-create-a-transformation) to help our customers develop their own Data Transformations which leverage the User Profile, User Redemption, and User Activity events. 
...
In this section, you’ll see the annotated templates. The body of these templates is designed to apply to the `/users/track` destination. Annotations are marked by the `//` line-start and green text, and you can delete them without affecting the operation of the transformation code. 
...
The templates in this guide are created to deliver to the "Track Users" destination, but you can design your template to send to any of the endpoints listed in [Braze's Data Transformation guide](https://www.braze.com/docs/user_guide/data/data_transformation/creating_a_transformation/#step-2-create-a-transformation), with the support of the associated [REST API documentation](https://www.braze.com/docs/api/home).
...
You'll find your Data Transformation's webhook URL in the transformation details panel. Copy this and use it for configuration within Oracle Crowdtwist's Integration Hub.
