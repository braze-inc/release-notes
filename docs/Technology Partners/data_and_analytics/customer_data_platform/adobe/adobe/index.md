...
![Destination mappings: IdentityMap:IDFA mapped to IdentityMap:external_id, IdentityMap:GAID mapped to IdentityMap:external_id, IdentityMap:Email mapped to IdentityMap:external_id, xdm:mobilePhone.number mapped to CustomAttribute:PhoneNumber, xdm:person.name.lastName mapped to CustomAttribute:LastName, xdm:person.name.firstName mapped to CustomAttribute:FirstName](https://www.braze.com/docs/assets/img/adobe/braze-destination-mapping-example.png?8d13fffda4184546e48198e871a145a0)
