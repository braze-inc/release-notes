...
Braze supports exporting all data listed in the [Currents event glossaries](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/) to RudderStack.
