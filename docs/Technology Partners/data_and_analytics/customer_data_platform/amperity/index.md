...
[Profile attributes](https://www.braze.com/docs/api/objects_filters/user_attributes_object#braze-user-profile-fields) describe who your customers are. They are often associated with the identity of the customer, such as:
- Names
- Birthdates
- Email addresses
- Phone numbers
...
![Dropdown list of filters with Custom Attributes displaying in the Custom Data category.](https://www.braze.com/docs/assets/img/amperity/custom_attributes_filters.png?9dc05d74dd6fe76a6a90b97e6cd13ef2){: style="max-width:60%;"}

![Dropdown list of custom attributes such as "l12m_frequency" and "l12m_monetary".](https://www.braze.com/docs/assets/img/amperity/search_custom_attributes_filters.png?0937bc1e93709c86cc6e8e35af99fef9){: style="max-width:40%;"}
...
2. Determine the [REST API endpoint](https://www.braze.com/docs/api/basics#endpoints) for your Braze instance. For example, if your Braze URL is `https://dashboard-03.braze.com`, your REST API endpoint is `https://rest.iad-03.braze.com` and your instance is “US-03”.
3. Determine a list of [user profile fields](https://www.braze.com/docs/api/objects_filters/user_attributes_object#braze-user-profile-fields) and [custom attributes](https://www.braze.com/docs/user_guide/data/activation/attributes/custom_attributes/) that may be sent to Braze from Amperity.
...
![The New Destination section with a name of "Braze API", description of "Send audience attributes to Braze.", and plugin of "Braze".](https://www.braze.com/docs/assets/img/amperity/destination_name.png?fd65ddf95754b6f33aa602d2ef5d1347){: style="max-width:60%;"}
...
![The Braze Settings section with an instance of "US-03", user identifier of "external_id", blank segment name, S3 bucket of "amperity-training-abc123", and S3 folder of "braze-attributes".](https://www.braze.com/docs/assets/img/amperity/braze_settings.png?bb12865814888623dc3015ce43b6f80d){: style="max-width:60%;"}
...
![The Data Template Name section with the name "Braze Audience Attributes" and description "Send audience attributes to Braze."](https://www.braze.com/docs/assets/img/amperity/data_template_name.png?1df454298bf7a91dfb2105aeb57f5575){: style="max-width:60%;"}
...
3. Select the segment of customers that you want to target with this campaign. This should be the segment you created earlier. <br>![The dropdown field for segments to exclude from targeting.](https://www.braze.com/docs/assets/img/amperity/select_segments.png?0443d475c93abdb42ad13bf3eae0be86){: style="max-width:50%;"}<br><br>
4. Choose the data you want to send as part of the campaign. This can include a range of customer attributes. ![The Edit Campaign Attributes modal allows for selecting a destination and customer attributes. ](https://www.braze.com/docs/assets/img/amperity/edit_campaign_attributes.png?35e4f792930d4803234053ddb1c58b8e){: style="max-width:90%;"}<br><br>
...
1. [Set up a Braze Current](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/setting_up_currents/) to send data to an Amazon S3 bucket.
