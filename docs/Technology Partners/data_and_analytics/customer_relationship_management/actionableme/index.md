...
To complete the integration, you must provide your REST API key and [REST endpoint URL](https://www.braze.com/docs/developer_guide/rest_api/basics/#endpoints) to your actionable.me operations team. actionable.me will then establish the connection and contact you after the setup is complete and be in touch to start sharing insights.

![The actionable.me "add platform" page that the actionable.me operations team will configure.](https://www.braze.com/docs/assets/img/actionableme/image2.png?eecd681b2a47a2e8ff461fc78fbb80df)
