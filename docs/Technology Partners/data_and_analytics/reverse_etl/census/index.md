...
![Census new destination dialog configured for Braze connection credentials.](https://www.braze.com/docs/assets/img/census/add_service.png?4613eee7ef8cd3b8431636c45b718579){: style="max-width:60%;"}
...
3. Configure where the model will be synced to. Select **Braze** as the destination and the [supported object type](#supported-objects) to sync.<br>![In the "Select a Destination" prompt, "Braze" is selected as the connection, and various objects are listed.](https://www.braze.com/docs/assets/img/census/census_2.png?1f590489fb6099200afc0d394d43627e){: style="max-width:80%;"}<br><br>
...
5. Next, for record matching purposes, choose a sync key to [map](#supported-objects) your Braze object to a model field.<br>![In the "Select a Sync Key" prompt, "External User ID" from Braze is matched to "user_id" in the source.](https://www.braze.com/docs/assets/img/census/census_1.png?6a2b6621125f081f1fd672d52a8d9df9){: style="max-width:80%;"}<br><br>
6. Lastly, map the Census data fields to the equivalent Braze fields.<br>![Census mapping](https://www.braze.com/docs/assets/img/census/census_3.png?af747940436866e9b2bda078feadd36d){: style="max-width:80%;"}<br><br>
