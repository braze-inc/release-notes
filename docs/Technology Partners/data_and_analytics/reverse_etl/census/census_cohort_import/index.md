...
> This article describes how to import user cohorts from [Census](https://www.getcensus.com/) to Braze. For more information on integrating Census, see the main [Census article](https://www.braze.com/docs/partners/data_and_analytics/reverse_etl/census/).
...
![Census new destination dialog configured for Braze cohort import credentials.](https://www.braze.com/docs/assets/img/census/add_service.png?4613eee7ef8cd3b8431636c45b718579){: style="max-width:60%;"}
...
7. Lastly, map the Census data fields to the equivalent Braze fields.<br>![Census mapping](https://www.braze.com/docs/assets/img/census/census_3.png?af747940436866e9b2bda078feadd36d){: style="max-width:80%;"}<br><br>
