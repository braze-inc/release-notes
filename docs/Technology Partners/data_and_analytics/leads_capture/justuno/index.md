...
To sync user attributes from Justuno to Braze, you'll need to create those attributes in Braze if you haven't already. You can do so by going to **Data Settings** > **Custom Attributes**, then creating your custom attributes. For a full walkthrough, see [Managing custom attributes in Braze](https://www.braze.com/docs/user_guide/data/activation/attributes/custom_attributes/).
...
![The "Connect Apps" page in Justuno with the Braze app shown in the list of search results.](https://www.braze.com/docs/assets/img/justuno/search-for-braze.png?baab2a140dadcadd2ee1b6150626d712)

Enter the API key and base URL [you created previously](#prerequisites), then select **Connect**.

![The Braze Authentication pop-up window asking for a Braze API key and base URL.](https://www.braze.com/docs/assets/img/justuno/authenticate-braze.png?b294dcc92b4931349a5a3479544e352f){: style="max-width:75%;"}
...
![The "Select App" option located on the "Sync to App" action.](https://www.braze.com/docs/assets/img/justuno/select-app.png?12504059194d9942133f4cec497113dc){: style="max-width:45%;"}
...
![The Braze app opened in a Justuno workflow with the option to add email and SMS subscription group IDs.](https://www.braze.com/docs/assets/img/justuno/enter-subscription-groups.png?1429a13524c195e28ad4bd4254dee3b0){: style="max-width:55%;"}
...
1. In the Braze app within your workflow, select **Sync Another Property**.
    ![The Braze app opened in a Justuno workflow showing the "Sync Another Property" option.](https://www.braze.com/docs/assets/img/justuno/sync-another-property.png?6c047d4fdcb01c6d8950fb5e9178f78e){: style="max-width:55%;"}
...
4. In the workflow builder, choose to **Save**, **Preview**, or **Publish** your workflow.
    ![The "Publish" menu opened with the options to save, preview, or show version history.](https://www.braze.com/docs/assets/img/justuno/publish-workflow.png?88b7ed49570f3d09226c61a3df743b65){: style="max-width:45%;"}
