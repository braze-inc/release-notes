...
![ViralSweep integrations page with Braze selected under Email and SMS services.](https://www.braze.com/docs/assets/img/viralsweep/connect.gif?92c61d3ac11e19e29a30dfaf95bc37ee)
...
![ViralSweep service integration page prompting the user for the Braze API key and Braze dashboard URL.](https://www.braze.com/docs/assets/img/viralsweep/connect2.png?51d4eeb202e186b9028b3684fc01ae4f){: style="max-width:40%;"}
