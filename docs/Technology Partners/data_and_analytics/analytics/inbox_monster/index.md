...
| Braze endpoint                 | [Your Braze endpoint](https://www.braze.com/docs/api/basics/#endpoints) aligns with your Braze dashboard URL.<br><br> For example, if your dashboard URL is `https://dashboard-03.braze.com`, your endpoint will be `dashboard-03`.                                                                                                                                                                                                                            |
