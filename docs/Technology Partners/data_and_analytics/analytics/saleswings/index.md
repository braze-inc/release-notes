...
![Example of a simple, click-not-code lead scoring model in SalesWings](https://www.braze.com/docs/assets/img/saleswings/example_lead_scoring_builder_braze_lead_scoring.png?6eddf6615ae5f1283d7f42d6b7716fef)
...
![Example of how SalesWings lead scoring prioritizes a list of accounts natively inside Salesforce](https://www.braze.com/docs/assets/img/saleswings/prioritized_account_list_braze_lead_scoring.png?b132f2fdcfaed393cb07f8e65e3c7023)
...
![Example of sales alert via Slack channel](https://www.braze.com/docs/assets/img/saleswings/smart_watch_alerts.png?f330b8160c6c5ff47bb5957aef746cbc)
...
![Example dashboard linked to Braze email & marketing engagement within Salesforce, looking at impact of Braze campaigns on sales results and outcomes](https://www.braze.com/docs/assets/img/saleswings/saleswings_email_campaign_attribution_dashboard.png?8c33c369f5699ed81682bf44f4ae7e9c)
...
![The Braze Integration section of the SalesWings Settings page.](https://www.braze.com/docs/assets/img/saleswings/saleswings_braze_lead_scoring_integration_settings.png?1e44db84167586552c6d8733c8b973e5)
...
Add your Braze API endpoint as described in [API and SDK endpoints article](https://www.braze.com/docs/user_guide/administer/personal/sdk_endpoints/), and enter it in the **Braze API endpoint** field. Copy the value of the **REST Endpoint** column and enter it in the **Braze API endpoint** field in the SalesWings **Braze Integration** section.
...
1. Appending `?braze_id=` followed by `{{${braze_id}}}` 
  - **Link example:** `https://www.your-website.com?braze_id={{${braze_id}}}`<br><br>

2. Appending `?br_user_id=` followed by `{{${user_id}}}`
  - **Link example:** `https://www.client-website.com?br_user_id={{${user_id}}}`
...
If you enable SalesWings insights push to Braze, SalesWings updates your Braze user profiles with the following [Custom Attributes](https://www.braze.com/docs/user_guide/data/activation/custom_data/data_types/):
...
![Example of an Event Name condition.](https://www.braze.com/docs/assets/img/saleswings/saleswings_braze_lead_scoring_custom_event_condition.png?a725d651477139da4c0f642835542df8)
