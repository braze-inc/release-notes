...
3. In Braze, go to **[Currents](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/setting_up_currents/)**.
...
![Optimizely authorization.](https://www.braze.com/docs/assets/img/optimizely/image1_authorization.png?3d3bb2fb18a9e9f54362b4aec8571c9d)
...
![Optimizely Braze segment sync.](https://www.braze.com/docs/assets/img/optimizely/image2_syncsegment.png?a0ca87d72e77549306eadb8faf79f28d)
...
![Optimizely and Braze segment map fields.](https://www.braze.com/docs/assets/img/optimizely/image3_emailmapfield.png?ee6efb2968ab83d195bd459cf4112684)
...
![Optimizely Braze Segment Save Field Maps](https://www.braze.com/docs/assets/img/optimizely/image4_mapfields.png?42e5f7175b96bb01347394d1f135eb1d)
...
![Optimizely Braze Segment Delete Field Maps](https://www.braze.com/docs/assets/img/optimizely/image5_deletephonefield.png?5923c590f80b76db6de65ee5d102cceb)
...
4. In the **Enrollment** section, you can sync data for customers that match a segment or sync data for customers that trigger an event (like when ODP registers that a customer opens an email):
   - **Customers that match a segment:** Select your desired segment, then select **Next**.<br><br>![Optimizely Select Segment](https://www.braze.com/docs/assets/img/optimizely/image6_segment.png?7d9a270c4dd671d39bfcc9fd4284de60)
   - **Customers that trigger an event:** Expand the **Filter** drop-down list and select the ODP event to use as the trigger for this data sync to Braze. Then, expand **Automation Rules** and adjust as desired. <br><br>![Optimizely Trigger Event](https://www.braze.com/docs/assets/img/optimizely/image7_trigger.png?6eadfc2e8f1de0983bb5a0e3da5d7ed5)
