...
| A Braze REST endpoint | [Your REST endpoint URL](https://www.braze.com/docs/developer_guide/rest_api/basics/#endpoints), which depends on the URL for your Braze instance. |
...
![The Braze integration card in Friendbuy.](https://www.braze.com/docs/assets/img/friendbuy/choosing_braze.png?37fa1dc53d857432761cfd588c0017cb){: style="max-width:75%;"}

In the form, enter your REST endpoint and API Key, then select **Install Integration**.

![The Friendbuy integration form.](https://www.braze.com/docs/assets/img/friendbuy/install_form.png?59b53f63037c19a89caf92ead1f5dcaa){: style="max-width:55%;"}
...
![integration installed](https://www.braze.com/docs/assets/img/friendbuy/install_success.png?6e037bb273f0db61f70b4c9505c10441){: style="max-width:55%;"}
...
![referral widget](https://www.braze.com/docs/assets/img/friendbuy/referral_widget.png?09465fae11421af4230165e35956e917)
