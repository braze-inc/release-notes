...
![Connected Content in email using Liquid to pull in information.](https://www.braze.com/docs/assets/img/trustpilot_connected_content_example.png?bbbeece80b3162b9164495d7bb399ed3){:style="max-width:38%;"}
...
{: start="2"}
2. Use Liquid syntax to pull the relevant content into your message. For example, to pull in the product review's content, use the Liquid tag `{{result.productReviews[0].content}}`.

![Personalized email with a review of a toy truck that the user left in their cart.](https://www.braze.com/docs/assets/img/trustpilot_personalized_email.png?62fbfd03542fa355901772a77d3e3a6d){:style="max-width:38%;"}