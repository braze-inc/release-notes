...
| `USER_ID`              | The User ID who will be receiving this particular video. For more examples of the identifiers which can be used, refer to [/users/track](https://www.braze.com/docs/api/endpoints/user_data/post_user_track).                                                                                                                                                  |
