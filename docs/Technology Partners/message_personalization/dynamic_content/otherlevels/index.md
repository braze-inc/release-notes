...
The Braze and OtherLevels integration allows you to create custom GenAI videos through API calls to the OtherLevels Experience Platform, and then send these videos to your users as iOS push videos through [Braze Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/making_an_api_call/).
...
| Placeholder             | Description                                                                                                                                                                                     |
|-------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `BRAZE_API_ENDPOINT`    | The Braze REST endpoint URL of your current Braze instance. For more information, refer to [REST API keys](https://www.braze.com/docs/user_guide/administrative/app_settings/api_settings_tab/#rest-api-keys). |
| `BRAZE_API_KEY`         | Your Braze REST API key with the `users.track` permission.                                                                                                                                      |
| `USER_ID`              | The User ID who will be receiving this particular video. For more examples of the identifiers which can be used, refer to [/users/track](https://www.braze.com/docs/api/endpoints/user_data/post_user_track#track-users).                                                                                                                                                  |
...
![Example Asset fields for Connected Content.](https://www.braze.com/docs/assets/img/otherlevels/1.png?ea14ca7c0ab0d57bdec8bb40f33219ad)
