...
- The "User history length percentile" parameter found in the Amazon Personalize console lets you adjust the percentile of user history to include in the training:<br><br>![Min max user profile setting](https://www.braze.com/docs/assets/img/amazon_personalize/min_and_max_user_percentile.png?a8a928ef28cace2341d30cd56a27e615)
...
In the Braze dashboard, create a new [Content Card campaign](https://www.braze.com/docs/user_guide/channels/content_cards/create_a_content_card/). In the message text field, create a Connected Content Liquid block to query the API and save the response in the `recommendations` variable:
...
![An image of a campaign with Connected Content added to the message body and "Add Image" field. This image also shows Connected Content logic added to the "Redirect to Web URL" field, linking users to a recommendation URL.](https://www.braze.com/docs/assets/img/amazon_personalize/content-card-campaign.png?6a17e2d2d7aea93398352740af5809cd)
