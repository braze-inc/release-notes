...
![An image breaking down the Braze personalization architecture noting how the different components interact with one another.](https://www.braze.com/docs/assets/img/amazon_personalize/braze-personalize-arch.png?b0dc79b3b3bd55b54267ce71c7e31083){: style="max-width:70%" }
...
![An image of the available AWS regions.](https://www.braze.com/docs/assets/img/amazon_personalize/region.png?c782e5bed174288140cf708bd2b4c13d){: style="float:right;max-width:40%;margin-top:15px;margin-bottom:10px;"}
