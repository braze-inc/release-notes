...
![Inspect and search for yotpo-main to find the data-product ID variable](https://www.braze.com/docs/assets/img/yotpo/image1.png?9e3934f03a6eeaba3fe1edfb17bf9b56)
...
4. Click **Edit email body** and add the respective [Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/) snippet for your use case:
...
![Replace YOTPO-API-KEY with your Yotpo Reviews API key](https://www.braze.com/docs/assets/img/yotpo/image2.png?412345da87adcec7ce76487751d24f0e)
...
![Example of email editor showing snippet for recent 5-star reviews](https://www.braze.com/docs/assets/img/yotpo/image3.png?47ed52cd95d131a425d8d1ccd41666bb)
...
![Example of email editor showing a snippet of images published in Yotpo](https://www.braze.com/docs/assets/img/yotpo/image4.png?0e3f0765a4c56adb4db7dadbcf638539)
...
![Example of email editor showing a snippet of customer loyalty balance](https://www.braze.com/docs/assets/img/yotpo/image5.png?2c8c2d1a8a79b6e7dddc029eccb9214b)
...
Yes! To discover other data points and customization options available, refer to [Making an API call](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/making_an_api_call/). You may need some assistance from a front-end developer to do so.
