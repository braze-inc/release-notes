...
1. In Braze, [create a webhook campaign](https://www.braze.com/docs/user_guide/channels/webhooks/create_a_webhook/).
...
![Compose tab of the webhook composer in Braze with the Movable Ink endpoint URL and Request Body set to JSON Key/Value Pairs.](https://www.braze.com/docs/assets/img/movable_ink/cd_api_webhook_url.png?6a1451f2a81313aaf4a0449b03ea16c5){: style="max-width:75%" }
...
![Settings tab of the webhook composer in Braze with key-value pairs for Content-Type and Authorization.](https://www.braze.com/docs/assets/img/movable_ink/cd_api_webhook_settings.png?f1e65b8a8cea51b32ce93faf7f209abc){: style="max-width:75%" }
...
![Compose tab of the webhook composer in Braze with JSON key-value pairs for ID, timestamp, user ID, and event type.](https://www.braze.com/docs/assets/img/movable_ink/cd_api_webhook_kvp.png?ffe62dfa0d6060abd04b4ac6a23c27e2){: style="max-width:75%" }
...
![Webhook response message in Braze showing a 200 OK response.](https://www.braze.com/docs/assets/img/movable_ink/cd_api_webhook_response.png?8333ba693afb9e46192e9a4ab91a8124){: style="max-width:75%" }

### Step 2: Finalize your campaign setup

#### Step 2a: Schedule your campaign

When you're done composing and testing the webhook, [schedule your campaign](https://www.braze.com/docs/user_guide/messaging/campaigns/schedule_your_campaign/). 
...
Next, determine which users you want to target for this campaign. For details, refer to [Targeting users](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/target_users/).
...
![A/B Testing panel in a Braze campaign with 100% variant distribution assigned to Variant 1, and no control group.](https://www.braze.com/docs/assets/img/movable_ink/cd_api_webhook_ab.png?509addc459dab75e17cb3f7597701b8b)
...
To learn more about custom event properties and the expected format of data contained within properties, refer to [Custom event properties](https://www.braze.com/docs/user_guide/data/activation/events/custom_events/custom_event_properties/).
