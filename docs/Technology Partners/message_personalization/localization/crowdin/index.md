...
![Braze Locales page under Settings, showing locale names, locale keys, and Add locale.](https://www.braze.com/docs/assets/img/crowdin/braze_locales.png?6b3cb3e542580fa4abb5dcac2d003878)
...
1. In your Crowdin Enterprise or Crowdin.com account, go to **Store** in the navigation menu.
2. Search for **Braze Campaigns & Canvas**, then select **Install**.

![Crowdin Store with Braze Campaigns & Canvas selected and Install highlighted.](https://www.braze.com/docs/assets/img/crowdin/crowdin_store_campaigns_canvas.png?3c6a34b1635054edd6a050ae8987e320)
...
![Crowdin Braze Campaigns & Canvas connection form with REST API key, REST endpoint, and Log in with Braze Campaigns & Canvas.](https://www.braze.com/docs/assets/img/crowdin/crowdin_campaigns_canvas_login.png?527460c453e904b00a53e8864a0adc3d)
...
- **Braze REST endpoint:** Enter the URL for your Braze instance (for example, `https://rest.iad-03.braze.com`). For more information, see [REST API endpoints](https://www.braze.com/docs/api/basics#endpoints).

![Braze REST API Keys page with Create API Key and the REST Endpoint copy control.](https://www.braze.com/docs/assets/img/crowdin/braze_rest_api_keys.png?0fbc73dd25c0997b647dff5f4eb1f5ed)
...
1. In the **Braze Campaigns & Canvas** integration dashboard, select the **Settings** gear icon in the top action bar.

![Braze Campaigns & Canvas integration screen with Settings in the top action bar.](https://www.braze.com/docs/assets/img/crowdin/crowdin_campaigns_canvas_settings.png?7886f4103b4584a4108856048eaf3e8f)
...
![Settings modal on the General Settings tab, showing file filter fields and language mapping rows (for example, French mapped to fr).](https://www.braze.com/docs/assets/img/crowdin/crowdin_language_mapping_settings.png?6cfa3fbaf38b150c455fc23680606c2d)
...
For HTML, Liquid in links, and other patterns, follow the same rules as in [Translating locales](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/localization/locales_in_messages) (for example, keep tags around the smallest segments possible, and wrap only language-specific parts of URLs when localizing links).
...
![Crowdin and Braze Campaigns & Canvas panels with folders for campaigns and locales, Sync to Braze, and Sync to Crowdin.](https://www.braze.com/docs/assets/img/crowdin/crowdin_campaigns_canvas_sync_panels.png?ae81ee92541f0d608551edbb7ff21577)

#### Syncing content

1. In the **Braze** panel, select the checkbox for the campaign or Canvas to translate.
2. Select **Sync to Crowdin**.
3. When the sync is complete, the file appears in the **Crowdin** panel. Translators can open the strings in the Crowdin Editor.

#### Returning translations to Braze

1. When translations are 100% complete in Crowdin, return to the **Integrations** tab.
2. Select the completed content in the **Crowdin** panel.
...
![Crowdin Store with Braze Email Templates selected and Install highlighted.](https://www.braze.com/docs/assets/img/crowdin/crowdin_store_email_templates.png?ca8cc179a46802acd69e6897c3603956)
...
![Crowdin Braze Email Templates connection form with REST API key, REST endpoint, and Log in with Braze Email Templates.](https://www.braze.com/docs/assets/img/crowdin/crowdin_email_templates_login.png?e4176426d3bbe95a6919b4da4d93c26d){: style="max-width:85%;"}
...
1. In the **Braze** panel, select the checkbox next to the templates or blocks you want to localize.
2. Select **Sync to Crowdin**.
...
![Crowdin Editor Preview tab showing localized email HTML and translatable strings.](https://www.braze.com/docs/assets/img/crowdin/crowdin_editor_wysiwyg_preview.png?2f762934dc99cb7a90097d73f935023e){: style="max-width:85%;"}

### Step 4: Deliver translated templates

When translations reach 100% completion:

1. Select the completed files in the **Crowdin** panel.
...
![Crowdin and Braze Email Templates panels listing Email Templates and Content Blocks, with Sync to Braze and Sync to Crowdin.](https://www.braze.com/docs/assets/img/crowdin/crowdin_email_templates_sync_panels.png?c3482f1fbdb37d25533ae624842b9e84)
