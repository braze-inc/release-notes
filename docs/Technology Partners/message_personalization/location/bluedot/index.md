...
![An action-based campaign in the delivery step. Here, you have two scheduling options that will send the campaign if a user performs a custom `bluedot_entry` or `bluedot_exit` event.](https://www.braze.com/docs/assets/img_archive/Campaign-Delivery-BD.png?1ca7431ef3e536a9cab9f580447c8a2a){: style="max-width:80%"}

#### Targeting users

Make sure to target **All Users** for your workspace.
![An action-based campaign with the target users step encouraging you to select "All Users" as the desired segment.](https://www.braze.com/docs/assets/img_archive/Campaign-Target_users-BD.png?de542a957e8530728379dc7b216ca0be){: style="max-width:80%"}
