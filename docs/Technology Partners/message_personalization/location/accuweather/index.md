...
![A Connected Content push message that says "It's raining! Grab an Umbrella!" shown on an Android device](https://www.braze.com/docs/assets/img_archive/connected_weather_push2.png?07ac11ca71aeb6cfbd4e478ca9d2cfcf "Connected Content Push Usage Example"){: style="max-width:40%"}
