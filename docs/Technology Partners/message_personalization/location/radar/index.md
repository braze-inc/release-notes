...
Additionally, Radar Geo APIs can be used to enrich or personalize your marketing campaigns through [Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/). 
...
| App identifier | Your [app identifier](https://www.braze.com/docs/api/identifier_types/?tab=app%20ids) can be found can be found within the Braze dashboard from **Settings** > **API Keys**. |
...
![An action-based delivery campaign showing that the campaign will be delivered when the "arrived_at_trip_destination" custom event occurs, and the "trip_metadata" equals "curbside".](https://www.braze.com/docs/assets/img_archive/radar-campaign.png?3900b016a0562d1ee76ad76b6324dbcd)
...
![A segment where "radar_geofence_tags" includes value my_store and "radar_updated_at" was less than 7 days ago.](https://www.braze.com/docs/assets/img_archive/radar-segment.png?1adece10979fdcdbf06e7950a0a0ddd7)

## Connected Content

The following example shows how to run a promotion to drive nearby users in-store with a digital offer. 

![An Android image of a Connected Content push message that displays "New In Store Deals, Walmart and target near you".](https://www.braze.com/docs/assets/img/radar_example.png?69ed4cc9df5c59afb81355fd52e6eecc){: style="float:right;max-width:30%;border:0;"}
