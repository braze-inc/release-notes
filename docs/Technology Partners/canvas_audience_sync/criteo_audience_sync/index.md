...
You must have the ["Admin" permission](https://www.braze.com/docs/user_guide/administrative/app_settings/manage_your_braze_users/user_permissions/#admin) to connect Criteo to your Braze account.
...
![Criteo technology page in Braze that includes an Overview section and Criteo section with the Connected Criteo button.](https://www.braze.com/docs/assets/img/criteo/criteo5.png?df83c0ee0e50731121a3d81a72345e20){: style="max-width:80%;"}
...
![A list of available ad accounts you can connect to Criteo.](https://www.braze.com/docs/assets/img/criteo/criteo7.png?572a99590f5bbe471c82e855edb77ce5){: style="max-width:80%;"}
...
![An updated version of the Criteo technology partners page showing the ad accounts successfully connected.](https://www.braze.com/docs/assets/img/criteo/criteo4.png?5db09c0ef661cd4ed28d22d56d23b4aa){: style="max-width:80%;"}
...
![Canvas entry filter showing Ads Tracking Enabled set to true.](https://www.braze.com/docs/assets/img/criteo/criteo11.png?d96daf1769ae8ae721a0e999e49b582d)
...
![Canvas entry filter using custom opt-in attributes for audience eligibility.](https://www.braze.com/docs/assets/img/criteo/criteo12.png?084dd4776c8b7df90a7060634454202e)
...
![Workflow of the previous steps to add a Criteo Audience component in Canvas.](https://www.braze.com/docs/assets/img/criteo/criteo9.png?271a9456051f8fa01d89d6256f204a9c){: style="max-width:35%;"} ![Workflow of the previous steps to add a Criteo Audience component in Canvas.](https://www.braze.com/docs/assets/img/criteo/criteo10.png?ee06583ed34e9f928120765788646425){: style="max-width:28%;"}
...
![Audience Sync step editor with Criteo selected as the partner.](https://www.braze.com/docs/assets/img/criteo/criteo6.png?0bcd286edfef3e3924ce532d31427fe6)
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account is selected, and a new audience is created.](https://www.braze.com/docs/assets/img/criteo/criteo3.png?2c36bffbed079c74f0990359532aa05b)
...
![An alert that appears after a new audience is created in the Canvas component.](https://www.braze.com/docs/assets/img/criteo/criteo1.png?20516318ec2309c559585c956e7a19a0)
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account and existing audience are selected.](https://www.braze.com/docs/assets/img/criteo/criteo8.png?2ac2e72e7d9da5b76a797f4a8e0e662c)
...
![The audience library showing the segment, id, source, type, size, currently used, and last update.](https://www.braze.com/docs/assets/img/criteo/criteo.png?0e72260ed9c616966053d8aa4901465e)
