...
![An example of an unconnected Audience Sync for The Trade Desk.](https://www.braze.com/docs/assets/img/audience_sync/trade_desk/connect_sync.png?7a9c8366855ba1cb0e65aaa1b0e98655){: style="max-width:90%;"}
...
![Option to select your partner to sync with the Audience Sync step.](https://www.braze.com/docs/assets/img/audience_sync/trade_desk/audience_sync_step.png?a2b2fb97c96de210afa21626848b45d8){: style="max-width:90%;"}
...
![Audience Sync setup with an audience field containing the name "valentines2025".](https://www.braze.com/docs/assets/img/audience_sync/trade_desk/choose_audience.png?d0faa98cf15ea1dfa49991f8d094957f){: style="max-width:90%;"}

{: start="3"}
3. Select an action to either **Add Users to Audience** or **Remove Users from Audience**.

![Audience Sync setup to add users to audience.](https://www.braze.com/docs/assets/img/audience_sync/trade_desk/audience_sync_step2.png?2b83271faec714fc58ad06917e7a1799){: style="max-width:90%;"}
