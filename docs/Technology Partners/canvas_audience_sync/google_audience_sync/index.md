...
<div id='sdk-versions'><a href='/docs/developer_guide/platforms/swift/changelog/#760' class='sdk-versions--chip ios-sdk' target='_blank'><i class='fa-brands fa-apple'></i> &nbsp; Swift: 7.6.0+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a><a href='/docs/developer_guide/platforms/web/changelog/#300' class='sdk-versions--chip web-sdk' target='_blank'><i class='fa-solid fa-desktop'></i> &nbsp; Web: 3.0.0+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a><a href='/docs/developer_guide/platforms/android/changelog/#132' class='sdk-versions--chip android-sdk' target='_blank'><i class='fa-brands fa-android'></i> &nbsp; Android: 1.3.2+ &nbsp;<i class='fa-solid fa-arrow-up-right-from-square'></i></a></div>
...
You must have the ["Admin" permission](https://www.braze.com/docs/user_guide/administrative/app_settings/manage_your_braze_users/user_permissions/#admin) to connect Google Ads to your Braze account.
...
![A GIF that shows the workflow of a successful Google Ads account connection to Braze.](https://www.braze.com/docs/assets/img/google_sync/googlesync.gif?884022051271fa3cba53a719e70ff2a3){: style="max-width:85%;"}
...
<br><br>
![The updated Google Ads technology page showing the Ad accounts connected, allowing you to re-sync accounts and add mobile advertising IDs.](https://www.braze.com/docs/assets/img/google_sync/google_sync5.png?fa4ed12fae442dd7de860fe7962e695c){: style="max-width:75%;"}
<br><br>
...
![The menu to select a Canvas component in the editor.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync3.png?f8c55b39f63207dc472a2c8aeaedff40){: style="max-width:35%;"} ![The Audience Sync step added to the user journey.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync5.png?cc74c79d5b1a336e22d0e016e3e1a7c5){: style="max-width:28%;"}
...
![The Audience Sync step settings with the option to select a partner to start the sync.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync4.png?51c2acce2b4ffaec0f219184b0ba1851){: style="max-width:80%;"}
...
![Expanded view of the Custom Audience Canvas component. Here, the desired Ad account is selected, a new audience is created, and the "customer contact info" checkbox is selected.](https://www.braze.com/docs/assets/img/audience_sync/g_sync.png?eed9c2f60cb9dc11a0ff85c853d0c7c9)
...
![An alert that appears after a new audience is created in the Canvas component.](https://www.braze.com/docs/assets/img/audience_sync/g_sync3.png?18077f765d242ba7b5ab5ad3233d5925)
...
![Expanded view of the Custom Audience Canvas component. Here, the desired Ad account and existing audience are selected, as well as the "Add user to Audience" radio button.](https://www.braze.com/docs/assets/img/audience_sync/g_sync2.png?165bcba548e3ac4372393bcac59b50fb)
