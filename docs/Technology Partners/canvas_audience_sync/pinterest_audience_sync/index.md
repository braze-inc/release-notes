...
You must have the ["Admin" permission](https://www.braze.com/docs/user_guide/administrative/app_settings/manage_your_braze_users/user_permissions/#admin) to connect Pinterest to your Braze account.
...
![Pinterest technology page in Braze that includes an Overview section and Pinterest Audience Sync section with the Connected Pinterest button.](https://www.braze.com/docs/assets/img/pinterest/pinterest1.png?6db7dffed36a1b2a1a6188a9c8dc10b9){: style="max-width:80%;"}
...
![A list of available ad accounts you can connect to Pinterest.](https://www.braze.com/docs/assets/img/pinterest/pinterest2.png?979eaf0d47bbbb3e08b5676f775b9bb1){: style="max-width:80%;"}
...
![An updated version of the Pinterest technology partners page showing the ad accounts successfully connected.](https://www.braze.com/docs/assets/img/pinterest/pinterest3.png?a9a1f90c5c79f89e6add8df56acb68ef){: style="max-width:80%;"}
...
![Audience Sync component editor with Pinterest selected as the sync partner.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync4.png?51c2acce2b4ffaec0f219184b0ba1851){: style="max-width:80%;"}
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account is selected, and a new audience is created.](https://www.braze.com/docs/assets/img/audience_sync/pinterest_sync.png?10e162d131b969c08037f38d5bf76922)
...
![An alert that appears after a new audience is created in the Canvas component.](https://www.braze.com/docs/assets/img/audience_sync/pinterest_sync3.png?946a684828fd0e0852620f61ef1665d2)
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account and existing audience are selected.](https://www.braze.com/docs/assets/img/audience_sync/pinterest_sync2.png?22d8569643615530160d651e1be696fb)
...
After you configure your Audience Sync to Pinterest, launch the Canvas! The new audience is created, and users who flow through the Audience Sync step are passed into this audience on Pinterest. If your Canvas contains subsequent components, your users advance to the next step in their user journey.
...
![Audience details for a given Pinterest audience that includes audience name, audience ID, audience type, audience size.](https://www.braze.com/docs/assets/img/pinterest/pinterest11.png?66628555a02da6f7216db59a117e6f9e)
