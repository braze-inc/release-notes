...
You must have the ["Admin" permission](https://www.braze.com/docs/user_guide/administrative/app_settings/manage_your_braze_users/user_permissions/#admin) to connect Snapchat to your Braze account.
...
![Snapchat technology page in Braze that includes an Overview section and Snapchat Audience Sync section with the Connected Snapchat button.](https://www.braze.com/docs/assets/img/snapchat/snapchat1.png?6fd12f428c4785c154d2bad2b9d0be15){: style="max-width:80%;"}
...
![A list of available ad accounts you can connect to Snapchat.](https://www.braze.com/docs/assets/img/snapchat/snapchat2.png?82e190813e2f54a858171c82ab57ce78){: style="max-width:80%;"}
...
![An updated version of the Snapchat technology partners page showing the ad accounts successfully connected.](https://www.braze.com/docs/assets/img/snapchat/snapchat3.png?484218cd21d56dfa5c276af4cfa1dc44){: style="max-width:80%;"}
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account is selected, and a new audience is created.](https://www.braze.com/docs/assets/img/audience_sync/snapchat3.png?4e787abad7440a5c5a368738056d6275)
...
![An alert that appears after a new audience is created in the Canvas component.](https://www.braze.com/docs/assets/img/audience_sync/snapchat2.png?b8b37e5f1e5d59f10b08723628b6b395)
...
![Expanded view of the Custom Audience Canvas step. Here, the desired Ad account and existing audience are selected.](https://www.braze.com/docs/assets/img/audience_sync/snapchat.png?efab535d02be14a763c74181ed37937d)
...
![Audience details for a given Snapchat audience that includes audience name, audience type, audience size, and audience retention in days.](https://www.braze.com/docs/assets/img/snapchat/snapchat7.png?850aa7977f7b35301eae52ff17c014b3)
