...
You must have the ["Admin" permission](https://www.braze.com/docs/user_guide/administrative/app_settings/manage_your_braze_users/user_permissions/#admin) to connect Facebook to your Braze account.
...
![Facebook technology page in Braze that includes an Overview section and Facebook Audience Export section with the Connected Facebook button.](https://www.braze.com/docs/assets/img/fb/afb_1.png?6757c1d1671c3b9f3f3bc55027514c53){: style="max-width:85%;"}

A Facebook oAuth dialog window appears to authorize Braze to create Custom Audiences into your Facebook ad accounts.

![The first facebook dialogue box prompting to "Connect as X", where X is your Facebook username.](https://www.braze.com/docs/assets/img/fb/afb_3.png?73879ac788fa80a6da419c5ddd57f996){: style="max-width:30%;"}  ![The second Facebook dialogue box prompting for permission to manage ads for your ad accounts.](https://www.braze.com/docs/assets/img/fb/afb_2.png?f8450d17698ad03e7947f59739c86b31){: style="max-width:40%;"}
...
![An updated version of the Facebook technology partners page showing the ad accounts successfully connected.](https://www.braze.com/docs/assets/img/fb/afb_5.png?301b8b7e079d36b0dd52fa1475aa0785){: style="max-width:85%;"}
...
<br><br>The Facebook oAuth configuration will also apply to [Facebook exports using Segments](https://www.braze.com/docs/partners/message_orchestration/additional_channels/retargeting/facebook/#prerequisites). 
...
![An example of the terms to accept for customer list custom audiences.](https://www.braze.com/docs/assets/img/fb_audience_sync/fb_sync_tos.png?ffc19be4bb09540b0f2ef298d16dae5e){: style="max-width:85%;"}
![An example of the terms to accept for Facebook business tools.](https://www.braze.com/docs/assets/img/fb_audience_sync/fb_sync_tos2.png?f1bfe21bb9847bf5989b892fb7141944){: style="max-width:85%;"}
...
![A list of components to add to the Canvas.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync3.png?f8c55b39f63207dc472a2c8aeaedff40){: style="max-width:35%;"} ![The Audience Sync component.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync5.png?cc74c79d5b1a336e22d0e016e3e1a7c5){: style="max-width:28%;"}

### Step 4: Sync setup

Select on the **Custom Audience** button to open the component editor. Then, select **Facebook** as the Audience Sync partner.

!["Set up Audience Sync" with options for choosing a partner.](https://www.braze.com/docs/assets/img/audience_sync/audience_sync4.png?51c2acce2b4ffaec0f219184b0ba1851){: style="max-width:80%;"}
...
![Audience sync setup to remove the email, phone, first name, and last name information.](https://www.braze.com/docs/assets/img/audience_sync/fb_sync3.png?6d7945395d22649b62519c67a9ea317c)
...
![Audience details and the History tab for a given Facebook audience that includes an Audience History table with columns for the activity, activity details, items changed, and the date and time.](https://www.braze.com/docs/assets/img/fb_audience_sync/audience_history.png?3fc59de04a3a591f7ec4c25bcce914bd){: style="max-width:80%;"}
...
![An account with full control permissions to manage an ad account.](https://www.braze.com/docs/assets/img/fb_audience_sync/ad_account_permission.png?fde5e72a4528b264b4bbe0c874c09ca1){: style="max-width:70%;"}
...
![The URL with the account ID and business ID highlighted.](https://www.braze.com/docs/assets/img/fb_audience_sync/fb_businessid_url.png?5c1b9a205b162e2ee6f682db08e9231f){: style="max-width:90%;"}
...
![The dropdown that shows the account that is signing the terms of service.](https://www.braze.com/docs/assets/img/fb_audience_sync/confirm_accept_tos.png?5cdfb3d4f371049de4b834663daed381){: style="max-width:90%;"}
...
3. In the navigation, select your **Account Overview**. <br> ![The navigation with Account Overview selected.](https://www.braze.com/docs/assets/img/fb_audience_sync/ads_manager_accouint_overview.png?14f44087f05d27bc43e5d648a1b7ac3d)
4. Check if there are any alerts that need to be addressed. <br> ![An account with an expired credit card.](https://www.braze.com/docs/assets/img/fb_audience_sync/resolve_alerts.png?e24a0ffbcc6941c634d5ed8c439b21bc)

{:start="5"}

5. Check if there are any setup tasks that need to be completed. <br> ![An account with a partially completed account setup.](https://www.braze.com/docs/assets/img/fb_audience_sync/confirm_tasks.png?9cbcd3993986117f96e3d63c82679b88)
