...
To create a Remerge webhook template for future campaigns or Canvases, go to **Content** > **Webhook** in the Braze platform. Then, select **Create webhook template**.
...
![The webhook URL and message preview shown in the Braze webhook builder.](https://www.braze.com/docs/assets/img_archive/webhook_remerge_preview.png?f27c043607db089dc690eb73e926de81)
...
![The request headers, HTTP method, and message preview shown in the Braze webhook builder.](https://www.braze.com/docs/assets/img_archive/httpmethod_remerge.png?c2357e71a629ce97b7631dd0523753f1)
