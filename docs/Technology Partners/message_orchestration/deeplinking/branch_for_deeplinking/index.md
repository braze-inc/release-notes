...
The Braze and Branch integration allows you to provide better experiences to your customers by allowing you to properly [attribute](https://www.braze.com/docs/partners/message_orchestration/attribution/branch_for_attribution/) the beginning of their user journey and connect them through deep links to their intended location.

**Tip:**


For help choosing the right deep linking approach for your use case, see [iOS deep linking guide](https://www.braze.com/docs/developer_guide/push_notifications/ios_deep_linking_guide).
...
Refer to the documentation on [Universal links and App Links](https://www.braze.com/docs/user_guide/channels/email/customize/universal_links_and_app_links/)
...
1. **Braze**: [Enable verbose logging](https://www.braze.com/docs/developer_guide/sdk_integration/verbose_logging/) and look for `Opening '<URL>':` entries. This confirms the SDK received the link.
