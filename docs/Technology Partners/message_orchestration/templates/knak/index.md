...
![Add integration button](https://www.braze.com/docs/assets/img/knak/integration-setup-step-2-add-new-integration.png?abebe7c282a747c4c12d2be0a9a65173)
...
![Create new integration](https://www.braze.com/docs/assets/img/knak/integration-setup-step-4-add-api-key.png?12d80cbe2ccb5ad402a3da5b02f14c16)

### Step 2: Sync your Knak templates

In Knak, locate an email you would like to sync to Braze and select **Publish** and then **Sync**.

![Knak integration 1](https://www.braze.com/docs/assets/img/knak/integration-post-step-1-sync.png?a3b987fe7e10aab775786a919357c3aa)

Next, verify the email name and click **Sync**.

![Knak integration 2](https://www.braze.com/docs/assets/img/knak/integration-post-step-2-asset-name.png?9eba0d9ac061d10a90d66cfdb1eed935)
