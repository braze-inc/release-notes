...
| Braze API campaign ID | The [Braze API campaign ID](https://www.braze.com/docs/api/api_campaigns/) is the unique identifier for all campaigns sent through SmarterSends. This can be created in the Braze dashboard at **Messaging** > **Campaigns**. |
...
1. In Braze, [create an API campaign](https://www.braze.com/docs/api/api_campaigns/#create-a-new-campaign).
