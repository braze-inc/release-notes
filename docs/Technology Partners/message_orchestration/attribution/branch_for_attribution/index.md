...
The Braze and Branch integration will help you understand exactly when and where users were acquired as well as how to personalize their journeys through robust attribution and [deep linking](https://www.braze.com/docs/partners/message_orchestration/deeplinking/branch_for_deeplinking/).
