...
| Braze Data Transformation | A [Data Transformation URL](https://www.braze.com/docs/user_guide/data/unification/data_transformation) is necessary to receive data from Stripe. |
...
![An example Stripe webhook configuration.](https://www.braze.com/docs/assets/img/stripe/stripe_webhook_configuration.png?5579c35af8d21e9e818c63adb6d2136d){: style="max-width:80%;"}
...
![An example of webhook details and transformation code.](https://www.braze.com/docs/assets/img/stripe/stripe_data_transformation.png?08e891fad3dc1ef6d14977138b80540b)
...
![A Stripe custom event "Charge Succeeded" in a Braze user profile.](https://www.braze.com/docs/assets/img/stripe/stripe_braze_profile_event.png?e8b71c76ec04ebb67ef27ff5b0bd71d6){: style="max-width:80%;"}
...
Refer to [Monitoring your transformation](https://www.braze.com/docs/user_guide/data_and_analytics/data_transformation/creating_a_transformation/#step-5-monitor-your-transformation) for more information on monitoring and troubleshooting your transformation.
