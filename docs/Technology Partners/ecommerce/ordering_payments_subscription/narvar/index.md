...
| Braze REST endpoint   | [Your REST endpoint URL](https://www.braze.com/docs/developer_guide/rest_api/basics/#endpoints), which depends on the URL for your Braze instance.         |
...
For each notification event, Narvar initiates a request to the Braze [`/messaging/send`](https://www.braze.com/docs/api/endpoints/messaging) endpoint to deliver a push message to each opted-in consumer.
