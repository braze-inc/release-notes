...
| Braze Data Transformation | A [Data Transformation URL](https://www.braze.com/docs/user_guide/data/unification/data_transformation) is necessary to receive data from Olo. |
