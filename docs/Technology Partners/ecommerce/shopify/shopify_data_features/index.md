...
For more information on how to build out a Liquid `for` loop to dynamically add all products into your email, refer to [Abandoned Cart product personalization for emails](https://www.braze.com/docs/ecommerce_use_cases/#abandoned-cart). 
...
Shopify’s checkout completed webhook doesn't contain product URLs or image URLs. As a result, you need to use Catalogs Liquid personalization as mentioned in [Abandoned Cart product personalization for emails](https://www.braze.com/docs/ecommerce_use_cases/#order-confirmation-and-feedback-survey). 
...
**Type**: [Custom Event](https://www.braze.com/docs/user_guide/data/activation/events/custom_events/)<br>
...
![The "Add Personalization" section with the "Attribute" dropdown extended.](https://www.braze.com/docs/assets/img/Shopify/add_personalization_2.png?46c5f72d613f05cd9cfd876aade5150a){: style="max-width:40%;"}

After selecting your custom attribute, input a default value and copy the Liquid snippet into your message.

![Pasting a Liquid snippet into a message.](https://www.braze.com/docs/assets/img/Shopify/copy_liquid_snippet.png?e4639641f291bb60fdb700a1ebe18aec)
...
For more information on what data is collected by the Braze SDKs, see [SDK data collection](https://www.braze.com/docs/user_guide/data/unification/user_data/sdk_data_collection/). 
...
The synced order event data is available for segmentation, but the revenue data itself does not populate in the user profile or the [Revenue – Last Touch Attribution dashboard](https://www.braze.com/docs/user_guide/analytics/reporting/dashboard_builder/#revenue---last-touch-attribution).

### Setting up Shopify historical backfill

1. Turn on historical backfill in the **Track Shopify data** step.

![The "Track Shopify data" step of the Shopify integration showing historical backfill selected.](https://www.braze.com/docs/assets/img/Shopify/historical_data_backfill_sync.png?364b55c6802557a4f26fe48dc8421884)
