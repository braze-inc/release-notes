...
{: start="2"}
2. On the Shopify partner page, select **Begin setup** to start the integration process.<br><br>![Shopify integration page with button to begin setup.](https://www.braze.com/docs/assets/img/Shopify/begin_setup.png?b6149351a6c71343d3c4a846a5a1ef9a)<br><br> 
3. In the Shopify app store, install the Braze application.<br><br>![The Braze app store page with a button to install the application.](https://www.braze.com/docs/assets/img/Shopify/shopify_log_in.png?b7e2d66c50606f4a87b4260d542c0393){: style="max-width:70%;"}
...
{: start="4"}
4. After installing the Braze app, you’ll be redirected to Braze to confirm the workspace you want to connect to Shopify. A Shopify store can connect to only one workspace. If you need to switch, select the correct workspace.<br><br>![A window asking you to confirm that you’re in the right workspace.](https://www.braze.com/docs/assets/img/Shopify/confirm_workspace1.png?13ab53ebf60d96e1b74c69a67d02cbde){: style="max-width:70%;"}

{: start="5"}
5. Select **Begin setup**.<br><br>!["Integration settings" with field to enter domain and a button to begin setup.](https://www.braze.com/docs/assets/img/Shopify/choose_account.png?b41c2a10ee022cda4dae1027efc1113e)
...
Through the standard setup, you can turn on historical backfill to target past customers. This imports your Shopify orders from the past 90 days and customer profiles from the past year. Both timeframes are counted back from the date you complete your integration. To do so, select the checkbox to include the initial data load as part of your integration.
...
![Historical data backfill toggle.](https://www.braze.com/docs/assets/img/Shopify/historical_data_backfill_sync.png?364b55c6802557a4f26fe48dc8421884)
...
If you’re an existing Braze customer with active campaigns or Canvases, review [Shopify data features](https://www.braze.com/docs/partners/ecommerce/shopify/shopify_data_features/#historical-backfill) for more details. 
...
![“Collect subscribers” section.](https://www.braze.com/docs/assets/img/Shopify/external_id_standard.png?c9ea384d79c2ed5b6b45c9be75879844)
...
![Banner that says you need to active the Braze app embed in Shopify and contains a button to open Shopify.](https://www.braze.com/docs/assets/img/Shopify/open_shopify.png?c0318891ea5efb8a45a93a81784a683c)

{: start="3"}
3. After you enable the app embed, your setup is complete!
Confirm you can view your integration settings, the status of initial data sync, and your active Shopify events. <br><br>![Shopify partner page displaying the integration settings.](https://www.braze.com/docs/assets/img/Shopify/install_complete.png?f5c153f06d5a688cd0fbe42b1f247c19)