...
Then, [include this setting](https://www.braze.com/docs/developer_guide/sdk_integration?sdktab=web) as a top-level key in your `vite.config.js` file:
...
![Shopify integration setup page on the Braze dashboard.](https://www.braze.com/docs/assets/img/Shopify/braze_shopify_integration_page.png?76e2c790ebaed82e9597ebfbdc085974)
...
![Setup step to enable Braze SDKs.](https://www.braze.com/docs/assets/img/Shopify/enable_braze_sdks_setup.png?e65d8e4cefedb26004cafb3635f1a3be)

### Step 3: Track Shopify data 

Enhance your integration by adding more Shopify events and attributes, which will be powered by Shopify webhooks. For detailed information on the data tracked through this integration, refer to [Shopify Data Features](https://www.braze.com/docs/shopify_data_features/). 

![Setup step to track Shopify data.](https://www.braze.com/docs/assets/img/Shopify/track_shopify_data_setup.png?4aa006cb4e88b2ce18a32fa113334116)

### Step 4: Historical backfill (optional)

Through the custom setup, you can optionally include the same historical Shopify data load as the [standard integration](https://www.braze.com/docs/partners/ecommerce/shopify/shopify_standard_integration/#historical-backfill-setup): order events from the past 90 days and user profiles from the past year, each counted back from the date you complete your integration. To include this initial data load, select the checkbox for the initial data load option.
...
![Section to set up historical data backfill.](https://www.braze.com/docs/assets/img/Shopify/historical_backfill_setup.png?b48a39d583221dacab77407c6a4d1900)

For the full list of data in the initial load, revenue reporting behavior, and monitoring the sync, see [Historical backfill](https://www.braze.com/docs/partners/ecommerce/shopify/shopify_data_features/#historical-backfill).
...
You can sync all products from your Shopify store to a Braze catalog for deeper messaging personalization. Automatic updates occur in near real-time so your catalog always reflects the latest product details. To learn more, check out [Shopify product sync](https://www.braze.com/docs/shopify_catalogs/).

![Setup step to sync product data to Braze.](https://www.braze.com/docs/assets/img/Shopify/sync_product_data.png?fa3c8eb21ed0a40db331fad95bbebc7d)
...
![Banner that says to activate the Braze app embed in Shopify so that you can finish setting up your integration.](https://www.braze.com/docs/assets/img/Shopify/shopify_app_embed_banner.png?c0318891ea5efb8a45a93a81784a683c)
