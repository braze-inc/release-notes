...
| ----------- | ----------- |
| Set up a Shopify store | Be sure that you've already [set up at least one Shopify store with Braze](https://www.braze.com/docs/shopify_overview/). |
...
![The "+ Connect New Store" button on the Shopify integration page.](https://www.braze.com/docs/assets/img/Shopify/begin_setup_button.png?5fc547fc22b5d7ed7b6f507a464680df){: style="max-width:80%;"}

For your additional Shopify regional store, select **Begin setup**.

![The "Integration settings" section with a button to "Begin setup".](https://www.braze.com/docs/assets/img/Shopify/multiple_stores.png?6f6501eadab5a567470f908764c83b01){: style="max-width:80%;"}

Like your first Shopify store integration, you can choose either between a standard or custom setup.

!["Enable the Braze SDKs" section with options to implement the Braze Web SDK with the standard or custom setup.](https://www.braze.com/docs/assets/img/Shopify/standard_or_custom.png?64d53ee671f9d3c3aefe42d89134cc43){: style="max-width:80%;"}
...
When a user profile is synced, the following fields will be merged. For full details on merging behavior, refer to [Merge behavior](https://www.braze.com/docs/api/endpoints/user_data/post_users_merge/#merge-behavior).
...
|Option|Resources|
|------|---------|
|API |- [Subscription group endpoints](https://www.braze.com/docs/api/endpoints/subscription_groups/) to directly replace what is supported by the integration<br>- [`Users/track` endpoint](https://www.braze.com/docs/api/endpoints/user_data/post_user_track/#set-subscription-groups) to set subscription group data or the [global email subscription state](https://www.braze.com/docs/user_guide/message_building_by_channel/email/managing_user_subscriptions/#subscription-states)<br>- [Braze preference center](https://www.braze.com/docs/user_guide/channels/email/subscriptions/) for more customized marketing opt-in collection options|
...
![An action-based Canvas with a trigger to enter users who perform the `ecommerce.order_placed` custom event.](https://www.braze.com/docs/assets/img/Shopify/ecommerce_order_placed.png?b3b6e1910c5c3bcd8275b98614c0f32d){: style="max-width:80%;"}
...
![An action-based Canvas with a trigger to enter users who perform the `shopify_paid_order` custom event.](https://www.braze.com/docs/assets/img/Shopify/shopify_paid_order.png?e2166e23f5d6984cf813f87994cb5467){: style="max-width:80%;"}
...
For a complete overview of all event payloads, refer to [Shopify data features](https://www.braze.com/docs/shopify_data_features/).
...
![Shopify catalogs with their Shopify store in their name.](https://www.braze.com/docs/assets/img/Shopify/catalog_store_name.png?e86d8c060a67062105d91d8e947b00ff)
