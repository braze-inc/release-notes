...
On the **Link your Braze Account** page, provide your Braze REST API key and select your Braze endpoint, which will depend on the Braze URL for [your instance](https://www.braze.com/docs/api/basics/#endpoints).
...
!["Nift service integration page prompting the user for the Braze API key and Braze dashboard URL.](https://www.braze.com/docs/assets/img/nift/link_your_braze_account.png?8d83ec8bea568392fc9c513c4662026a)
