...
![Iterate link options](https://www.braze.com/docs/assets/img/iterate.png?eb2f7ab8d434d8f650839a471c6270a2)
...
- **Include a link**
  - Copy the link under **Survey Link** in the Braze integration section of the **Send survey** tab. Note that the Liquid included in the link `?user_braze_id={{${braze_id}}}` will automatically be replaced for each user upon send.
