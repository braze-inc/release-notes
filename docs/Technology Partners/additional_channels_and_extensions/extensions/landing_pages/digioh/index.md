...
> [Digioh](https://www.digioh.com/) supports list growth, first-party data capture, and use of that data in Braze campaigns.
...
!["Create flexible email and communications preference centers with Digioh"](https://www.braze.com/docs/assets/img/digioh/pref_pop_examples.png?e6f94bc2a4f74f015dda662ce7a817c2){: style="border:0"}
...
| Braze API `/users/track/` endpoint | Your REST endpoint URL with the `/users/track/` details appended to it. Your endpoint will depend on the [Braze URL for your instance](https://www.braze.com/docs/api/basics/#endpoints).<br><br>For example, if your REST API endpoint is `https://rest.iad-01.braze.com` your `/users/track/` endpoint will be `https://rest.iad-01.braze.com/users/track/`. |
...
!["Select the correct integration from the dropdown"](https://www.braze.com/docs/assets/img/digioh/2.png?becec63aa5d694b294e8659c6a884161){: style="max-width:50%;"}
...
!["Add the integration to a lightbox"](https://www.braze.com/docs/assets/img/digioh/3.png?18296ed20c7b68af4c1f4a328e04620e){: style="max-width:90%"}
