...
To further enrich your customers' mobile wallet experiences, from within your PassKit dashboard, you can opt to pass data into Braze through the Braze [`/users/track` endpoint](https://www.braze.com/docs/api/endpoints/user_data/#user-track-endpoint). 
...
1. Within **Settings**, under **Integrations** in your PassKit pass project or program click **Connect** under the **Braze** Tab.<br>![The Braze integration tile in the PassKit platform.](https://www.braze.com/docs/assets/img/passkit/passkit5.png?12f1de19ecf53e61753e84c24eaba4b7){: style="max-width:80%"}<br><br>
2. Fill out your Braze API key, endpoint URL, and provide a name for your connector.<br><br>
3. Toggle **Enable Integration** and whichever events you want in Braze to trigger or personalize your messages with.<br>![The PassKit Braze integration tile expanded to accept the API key, endpoint URL, integration name, enablement settings, membership settings, and pass settings.](https://www.braze.com/docs/assets/img/passkit/passkit4.png?9e5bfa1eb74b3724329a3129a151fe58){: style="max-width:70%"}

## Create pass using a SmartPass link

Within Braze, you can set up a SmartPass link to generate a unique URL for your customers to install their pass on either Android or iOS. To do this, you must define an encrypted SmartPass data payload that can be called from a Braze Content Block. This [Content Block](https://www.braze.com/docs/user_guide/engagement_tools/templates_and_media/content_blocks/#content-blocks) can then be reused for future passes and coupons. The following is used during your integration:
...
`{{passData}}` - Your JSON pass data payload defined in [step 1](#passkit-integrations) <br>
...
![An image of the Content Block message composer with the captured JSON and Content Block reference shown.](https://www.braze.com/docs/assets/img/passkit/passkit1.png?c8a74a82d2e5ff4672bbb8d146411a7c){: style="max-width:70%"}

The output URL for the sample is:
![The output URL that includes a long, randomly generated string of letters and numbers.](https://www.braze.com/docs/assets/img/passkit/passkit2.png?f8a982499b55303208fa49bd4bd5cc82){: style="max-width:70%"}
...
Remember to save your template before leaving the page! <br>Updated webhook templates can be found in the **Saved Webhook Templates** list when creating a new [webhook campaign](https://www.braze.com/docs/user_guide/channels/webhooks/create_a_webhook/). 



## Retrieve pass details via Connected Content

In addition to creating and updating passes, you can also retrieve your users' pass metadata via Braze [Connected Content](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/connected_content/making_an_api_call/) to incorporate personalized pass details within your messaging campaigns.
