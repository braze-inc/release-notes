...
1. In the Zendesk developer console, go to webhooks: `https://{{url}}.zendesk.com/admin/apps-integrations/webhooks/webhooks`
...
![An example Zendesk webhook.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat1.png?e42df91a225e8da33975a382c027f4a4){: style="max-width:70%;"}
...
![An example SMS without formatting.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat2.png?9b3d1db50f631bab6bc95bcd471fb361){: style="max-width:40%;"}
...
![An example SMS with formatting.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat3.png?f9aa692f1867807475a269bbfc89eb2e){: style="max-width:70%;"}
...
![API Triggered delivery](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat4.png?6f17ff982ddfdb057b61e5fcaec9f50e){: style="max-width:70%;"}

Finally, under **Delivery Controls**, turn on re-eligibility.

![Re-eligibility enabled under "Delivery Controls."](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat5.png?ae3a653058c05e4ad061eb761f8d8d7b)
...
![Respond via SMS Braze.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat6.png?b06315dd101720f6f375a7b04d229991){: style="max-width:70%;"}
...
![Respond via SMS Braze JSON body.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat7.png?cccf3299108df52970afd0f9cd3ec5f8){: style="max-width:70%;"}
...
![Update a user when ticket is closed.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat8.png?5c2e50aa4c5f015631db59777e5fcb41){: style="max-width:70%;"}
...
![Solved ticket set up in Zendesk.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat9.png?0ba1dc9fa38028b3d46771b4a7cefd3d){: style="max-width:70%;"}
...
![Solved ticket JSON body.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat10.png?af4e5feb5da2325c99ce44d006b5f275){: style="max-width:70%;"}
...
![An example SMS keyword category in Braze.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat11.png?598014bd0fd00d124a72c9d552f202c7){: style="max-width:70%;"}
...
![An example request with the two required headers.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat12.png?6592e90775e44082d775077a4d18f01b){: style="max-width:70%;"}
...
![The "Schedule Delivery" page for the first webhook campaign.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat13.png?f5124275d8978cd6bd71c21b6d44bd6f)

Under **Delivery Controls**, turn on re-eligibility.

![Re-eligibility selected under "Delivery Controls" for the first webhook campaign.](https://www.braze.com/docs/assets/img/zendesk/instant_chat/chat14.png?bc130a747a42c83a6c9eef2fa3669fbb)
...
[2]: /docs/assets/img/zendesk/instant_chat/chat2.png?9b3d1db50f631bab6bc95bcd471fb361
