...
Before setting up a new transformation in Braze, we recommend reviewing the support matrix for each tier in our [Data Transformation](https://www.braze.com/docs/user_guide/data/unification/data_transformation/) documentation. Our Free and Pro tiers offer a different number of active transformations and incoming requests per month. Confirm the current plan you’re on can support your use case.
...
| Braze Data Transformation Webhook URL | [Braze Data Transformation](https://www.braze.com/docs/user_guide/data/unification/data_transformation/) will be used to reformat the incoming webhook from Front so it can be accepted by the Braze /users/track endpoint.|
...
First, you'll create a new data transformation in Braze. The following steps are simplified; for a full walkthrough, see [Creating a transformation](https://www.braze.com/docs/user_guide/data/unification/data_transformation/creating_a_transformation/).
...
You can modify this template to meet your specific needs. For example, you can customize the pre-set custom event name. For more information, see [Data transformation overview](https://www.braze.com/docs/user_guide/data/unification/data_transformation/). 
...
![An example message using Liquid code.](https://www.braze.com/docs/assets/img/front/sms_to_braze.png?f8411e9df22d6e66ed994382ef741822){: style="max-width:80%;"}
...
![The "Schedule Delivery" page.](https://www.braze.com/docs/assets/img/front/custom_event_trigger.png?b13fdc37bc85360583375d40a09ea85c)
...
![Re-eligibility enabled under "Delivery Controls."](https://www.braze.com/docs/assets/img/front/braze_reeligibility.png?91f9dff4413c05ed5a0a1ed68e4d77e2)
...
![A custom channel for Braze in the Front dashboard.](https://www.braze.com/docs/assets/img/front/front_custom_channel.png?dd64590f5ffb0e6eb7e0890a75f95234)
...
![The channel settings for the newly created Braze channel in Front.](https://www.braze.com/docs/assets/img/front/front_custom_channel2.png?ef47cf2711def70d3eb3e64c5fe54e6c){: style="max-width:65%;"}
...
![An example SMS keyword category in Braze.](https://www.braze.com/docs/assets/img/front/front_keyword.png?f7a4ba619b66f73b4df49573860c3485){: style="max-width:65%;"}
...
![An example of the first webhook campaign that should be created in Braze.](https://www.braze.com/docs/assets/img/front/sms_to_front.png?2dd48512e6534050208a5b6227e251c4){: style="max-width:65%;"}
...
![An example request with the three required headers.](https://www.braze.com/docs/assets/img/front/webhook_settings.png?e1ad11dff0285687c0c757c157b2df7d){: style="max-width:65%;"}
...
![The "Schedule Delivery" page for the first webhook campaign.](https://www.braze.com/docs/assets/img/front/front_actionbased_keyword.png?c3c1acf52ca9d2ddb971294950014923)

Under **Delivery Controls**, enable re-eligibility.

![Re-eligibility selected under "Delivery Controls" for the first webhook campaign.](https://www.braze.com/docs/assets/img/front/braze_reeligibility.png?91f9dff4413c05ed5a0a1ed68e4d77e2)

#### Step 5.4: Create your second webhook campaign

Because your second webhook campaign matches the first, you can [duplicate the first one and rename it](https://www.braze.com/docs/user_guide/engagement_tools/campaigns/managing_campaigns/duplicating_segments_and_campaigns/#duplicating-segments-or-campaigns).
...
![The "Scheduled Delivery" page for the second webhook campaign, with "Other" chosen as the keyword category.](https://www.braze.com/docs/assets/img/front/front_actionbased_other_keyword.png?8b2f045c9bc9213128d484d5d1e6613d)
...
![An audience filter with "Last Received Message From Specific Campaign" selected.](https://www.braze.com/docs/assets/img/front/front_segment_last_received_message.png?2a9b74974f203ab9e5cbba41230753b2){: style="max-width:65%;"}
...
![The configuration settings for the selected audience filter.](https://www.braze.com/docs/assets/img/front/front_target_audience.png?0f3cc079a37535414f0f63a2451b5cad)

## Considerations

### Billable Segments

- SMS messages at Braze are charged per message segment. Understanding what defines a segment and how these messages will be split is key in understanding how you will be billed for messages. See more information in our [documentation](https://www.braze.com/docs/user_guide/channels/sms_mms_and_rcs/billing_calculator/).
