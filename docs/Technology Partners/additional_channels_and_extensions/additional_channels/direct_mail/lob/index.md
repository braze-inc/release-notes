...
![Request body code and webhook URL shown in the Braze webhook builder compose tab.](https://www.braze.com/docs/assets/img_archive/lob_full_request.png?ee8ce5a1675a81a6000688c5782d8c05)
...
![A message error log showing the time, app name, channel, and error message. The error message includes the message alert and the status code.](https://www.braze.com/docs/assets/img_archive/error_log.png?3269769ee994796e6eeb21c969b148b0)

## Sharing events using Lob webhooks 

[Braze Data Transformation](https://www.braze.com/docs/user_guide/data/unification/data_transformation/) lets you build and manage webhooks for automating data flow from external platforms into Braze. Each transformation is given a unique endpoint, which other platforms can use for their webhook's destination.

**Important:**


Lob's Data Transformation template sends events using your [`/users/track` endpoint](https://www.braze.com/docs/api/endpoints/user_data/post_user_track), which logs data points. We recommend setting a rate limit in your Lob webhook settings to avoid over-logging data.
