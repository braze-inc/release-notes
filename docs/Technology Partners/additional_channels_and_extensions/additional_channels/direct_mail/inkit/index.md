...
![A selection of available predesigned webhook templates in the Webhook Templates tab of the Templates & Media section.](https://www.braze.com/docs/assets/img/inkit-webhook-template.png?d6b421e6ad25e1556ca0cb9fa64f03ae)
...
![Request body code and webhook URL shown in the Braze webhook builder compose tab.](https://www.braze.com/docs/assets/img/inkit-integration.png?e98531b7d29904b236c12f11ccba791d)
...
Your raw text will automatically highlight if it is an applicable Braze tag. `street`, `unit`, `state`, and `zip` must be set up as [custom attributes](https://www.braze.com/docs/user_guide/data_and_analytics/custom_data/custom_attributes/#custom-attributes) to send this Webhook.
