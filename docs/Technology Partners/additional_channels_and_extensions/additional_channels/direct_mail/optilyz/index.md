...
![The request headers and HTTP method shown in the Braze webhook builder.](https://www.braze.com/docs/assets/img/optilyz/optilyz_settings.png?5695a17bd1e7731917c23d929bb4bc92){: style="max-width:50%"}
...
![An image of the request body code and webhook URL shown in the Braze webhook builder compose tab.](https://www.braze.com/docs/assets/img/optilyz/optilyz_compose.png?0a37151afd8e58afe9d5dfa6df5ea74b)
...
![Different testing fields available in the test tab of the Braze webhook builder.](https://www.braze.com/docs/assets/img/optilyz/optilyz_testing.png?7d0b65d19296e243f8d6a088a24b730d)
