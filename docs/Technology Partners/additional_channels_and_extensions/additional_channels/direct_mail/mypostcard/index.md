...
To integrate with MyPostcard, [log in or sign up](https://www.mypostcard.com/b2b/admin/) and create your first campaign to use it through [Braze webhooks](https://www.braze.com/docs/user_guide/channels/webhooks/).
...
If you are using the [older navigation](https://www.braze.com/docs/user_guide/administer/personal/the_braze_dashboard/), go to **Engagement** > **Templates & Media** > **Webhook Templates**.
...
![Compose Tab showing the JSON body and webhook information.](https://www.braze.com/docs/assets/img/mypostcard/mypostcard_compose.jpg?7a78402cbd3daf95a7aee779703ee9c9)
...
![Test Webhook Tab with different fields to validate the implementation.](https://www.braze.com/docs/assets/img/mypostcard/mypostcard_test.jpg?836b8dc5806e40b9d0bb0c4e8a665eb5)
