...
> The `email` object allows you to modify or create emails through our [messaging endpoints](https://www.braze.com/docs/api/endpoints/messaging).
...
- For more information and best practices on preheaders, see [Email styling](https://www.braze.com/docs/user_guide/channels/email/best_practices/email_styling).
...
![API Identifier section of an HTML email template.](https://www.braze.com/docs/assets/img_archive/email_template_id.png?f5ef66efa3748211b094601308c2dcec){: style="max-width:70%;"}
...
Use a stored basic authentication credential when an attachment URL requires a login. This applies to attachments in the email object on [`/messages/send`](https://www.braze.com/docs/api/endpoints/messaging/send_messages/post_send_messages) and to the top-level `attachments` array on [`/campaigns/trigger/send`](https://www.braze.com/docs/api/endpoints/messaging/send_messages/post_send_triggered_campaigns).
