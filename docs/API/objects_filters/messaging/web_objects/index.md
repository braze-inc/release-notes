...
> The `web_push` object allows you to define or request information related to web push and web push alert content via our [messaging endpoints](https://www.braze.com/docs/api/endpoints/messaging).
