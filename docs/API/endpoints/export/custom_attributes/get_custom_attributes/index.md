<div id='api_bkaiixjutqpp' class='api_div' data-search-keywords='export custom attributes message attributes array_length data_type description name status tag_names'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">custom_attributes.get</code> permission.</p>
