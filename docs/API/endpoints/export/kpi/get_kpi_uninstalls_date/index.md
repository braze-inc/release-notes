<div id='api_lruyxhhbkkie' class='api_div' data-search-keywords='export kpis for daily app uninstalls by date message data time uninstalls'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">kpi.uninstalls.data_series</code> permission.</p>
