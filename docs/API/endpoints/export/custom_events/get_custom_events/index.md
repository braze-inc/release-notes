<div id='api_rsuodemgcvgt' class='api_div' data-search-keywords='export custom events list message events'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">events.list</code> permission.</p>
