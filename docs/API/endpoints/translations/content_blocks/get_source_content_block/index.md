<div id='api_htbwkhaxwtjf' class='api_div' data-search-keywords='view default source values for a content block’s translation tags translations translation_map id_0 id_1 message errors'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">content_blocks.translations.get</code> permission.</p>
...
2
3
</pre></td><td class="rouge-code"><pre>curl --location --request GET 'https://rest.iad-03.braze.com/content_blocks/translations/source?content_block_id={content_block_id}&amp;locale_id={locale_uuid}' \
...
9
           ...
           </span><span class="nl">"id_0"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Welcome!"</span><span class="p">,</span><span class="w">
           </span><span class="nl">"id_1"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Thank you for joining our program"</span><span class="w">
