<div id='api_lvdgbrtosduq' class='api_div' data-search-keywords='update translation in a canvas workflow_id step_id message_variation_id locale_id translation_map id_3 message errors'>
...
<blockquote>
  <p>Use this endpoint to update multiple translations for a Canvas. See <a href="/docs/user_guide/messaging/messaging_fundamentals/localization/locales_in_messages">Locales in messages</a> for more information about translation features.</p>
</blockquote>

<p>If you want to update translations after a Canvas has been launched, you’ll need to <a href="/docs/post-launch_edits">save your message as a draft</a> first.</p>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Request parameters">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Object containing the new translations.</td>
    </tr>
  </tbody>
</table>
...
9
    ...
    </span><span class="nl">"workflow_id"</span><span class="p">:</span><span class="w"> </span><span class="s2">"a74404b3-3626-4de0-bdec-06935f3aa0ad"</span><span class="p">,</span><span class="w">
    </span><span class="nl">"step_id"</span><span class="p">:</span><span class="w"> </span><span class="s2">"a74404b3-3626-4de0-bdec-06935f3aa0ac"</span><span class="p">,</span><span class="w">
    </span><span class="nl">"message_variation_id"</span><span class="p">:</span><span class="w"> </span><span class="s2">"a74404b3-3626-4de0-bdec-06935f3aa0ac"</span><span class="p">,</span><span class="w">
        ...
        </span><span class="nl">"id_3"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Ein Absatz ohne Formatierung"</span><span class="w">
