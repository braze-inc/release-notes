<div id='api_uknweaabpyiw' class='api_div' data-search-keywords='view default source values for a campaign’s translation tags translations translation_map id_0 id_1 message errors'>
...
2
3
</pre></td><td class="rouge-code"><pre>curl --location --request GET 'https://rest.iad-03.braze.com/campaigns/translations/source?campaign_id={campaign_id}&amp;message_variation_id={message_variation_id}&amp;locale_id={locale_uuid}&amp;post_launch_draft_version=true' \
