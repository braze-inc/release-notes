<div id='api_xenjfcswqbtx' class='api_div' data-search-keywords='view the source translations for an email template translations translation_map id_0 id_1 message errors'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">templates.email.info</code> permission.</p>
