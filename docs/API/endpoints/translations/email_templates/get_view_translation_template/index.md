<div id='api_rwccequlqvpv' class='api_div' data-search-keywords='view all translations and locales for an email template translations locale uuid name country language locale_key translation_map id_0 id_1 id_2 errors message'>
