<div id='api_xxeppvwjwlez' class='api_div' data-search-keywords='remove hard bounced emails email'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">email.bounce.remove</code> permission.</p>
