<div id='api_grsxymgdmttm' class='api_div' data-search-keywords='look up an existing dashboard user account by resource id schemas id name department permissions roles team status detail'>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Response parameters">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Object</td>
      <td>Company, workspace, team, and role permissions for the user. See the <a href="/docs/scim_api_appendix">permissions object</a>.</td>
    </tr>
  </tbody>
</table>
