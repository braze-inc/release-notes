<div id='api_cqttjipjsmap' class='api_div' data-search-keywords='look up an existing dashboard user account by resource id schemas id name department permissions roles team status detail'>
