<div id='api_ycvrllitgvsw' class='api_div' data-search-keywords='create catalog fields message errors id parameters parameter_values'>
...
<blockquote>
  <p>Use this endpoint to create multiple fields in your catalog.</p>
</blockquote>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Request parameters">
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Array</td>
      <td>An array that contains field objects. The fields objects should contain the name and type of the new fields.</td>
    </tr>
  </tbody>
</table>
...
<p>You must provide geolocation field values as a <code class="language-plaintext highlighter-rouge">[longitude, latitude]</code> array—for example, <code class="language-plaintext highlighter-rouge">[-73.988103, 40.779109]</code>. Latitude must be between -90 and 90; longitude must be between -180 and 180.</p>
...
<table class="reset-td-br-1 reset-td-br-2" aria-label="Troubleshooting">
  ...
  <tbody>
    ...
    <tr>
      <td><code class="language-plaintext highlighter-rouge">request-includes-too-many-fields</code></td>
      <td>Each request can support up to 50 new fields.</td>
    </tr>
    <tr>
      <td><code class="language-plaintext highlighter-rouge">catalog-exceeds-fields-limit</code></td>
      <td>Catalog cannot have more than 500 fields.</td>
    </tr>
  </tbody>
</table>
