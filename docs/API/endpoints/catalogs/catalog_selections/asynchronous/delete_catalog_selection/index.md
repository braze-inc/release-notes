<div id='api_kavyttxmxbyt' class='api_div' data-search-keywords='delete catalog selection message errors id parameters parameter_values'>
...
<blockquote>
  <p>Use this endpoint to delete a catalog selection.</p>
</blockquote>

<h2 id="prerequisites">Prerequisites</h2>

<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">catalogs.delete_selection</code> permission.</p>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Path parameters">
  ...
  <tbody>
    ...
    <tr>
      <td><code class="language-plaintext highlighter-rouge">selection_name</code></td>
      <td>Required</td>
      <td>String</td>
      <td>Name of the catalog selection.</td>
    </tr>
  </tbody>
</table>
...
2
3
</pre></td><td class="rouge-code"><pre>curl --location --request DELETE 'https://rest.iad-03.braze.com/catalogs/restaurants/selections/favorite_list' \
...
<table class="reset-td-br-1 reset-td-br-2" aria-label="Troubleshooting">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Check that the selection name is valid.</td>
    </tr>
  </tbody>
</table>
