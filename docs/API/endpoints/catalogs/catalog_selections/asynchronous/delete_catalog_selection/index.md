<div id='api_tbxbqukojccg' class='api_div' data-search-keywords='prerequisites message errors id parameters parameter_values'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key/">API key</a> with the <code class="language-plaintext highlighter-rouge">catalogs.delete_selection</code> permission.</p>
