<div id='api_dnhmbtshfefv' class='api_div' data-search-keywords='replace catalog item message errors id parameters parameter_values'>
...
<blockquote>
  <p>Use this endpoint to replace an item in your catalog.</p>
</blockquote>

<p>If the <code class="language-plaintext highlighter-rouge">item_id</code> isn’t found, this endpoint will create the item in your catalog. This endpoint is synchronous.</p>

<div class="api_reference postman"><a href="https://documenter.getpostman.com/view/4689407/SVYrsdsG?version=latest#b2871ed7-734e-4a37-b8f1-e11584e569f5" class="seeme">See me in Postman</a></div>

<h2 id="prerequisites">Prerequisites</h2>

<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">catalogs.replace_item</code> permission.</p>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Request parameters">
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Array</td>
      <td>An array that contains item objects. The item objects should contain fields that exist in the catalog except for the <code class="language-plaintext highlighter-rouge">id</code> field. Only one item object is allowed per request.</td>
    </tr>
  </tbody>
</table>
...
20
21
</pre></td><td class="rouge-code"><pre>curl --location --request PUT 'https://rest.iad-03.braze.com/catalogs/restaurants/items/restaurant1' \
