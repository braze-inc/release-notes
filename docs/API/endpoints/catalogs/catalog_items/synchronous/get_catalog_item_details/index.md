<div id='api_kkpjiezvtkfp' class='api_div' data-search-keywords='list catalog item details items id message errors parameters parameter_values'>
...
<div class="api_reference postman"><a href="https://documenter.getpostman.com/view/4689407/SVYrsdsG?version=latest#52c6631c-7366-48e5-9e0e-16de7b6285cc" class="seeme">See me in Postman</a></div>
...
2
3
</pre></td><td class="rouge-code"><pre>curl --location --request GET 'https://rest.iad-03.braze.com/catalogs/restaurants/items/restaurant1' \
...
14
      ...
      </span><span class="nl">"Open_Time"</span><span class="p">:</span><span class="w"> </span><span class="s2">"2022-11-01T09:03:19.967Z"</span><span class="w">
    </span><span class="p">}</span><span class="w">
  </span><span class="p">],</span><span class="w">
...
<p>The status code <code class="language-plaintext highlighter-rouge">404</code> could return the following response. Refer to <a href="#troubleshooting">Troubleshooting</a> for more information about errors you may encounter.</p>
...
15
      ...
      </span><span class="nl">"id"</span><span class="p">:</span><span class="w"> </span><span class="s2">"item-not-found"</span><span class="p">,</span><span class="w">
      </span><span class="nl">"message"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Could not find item"</span><span class="p">,</span><span class="w">
        ...
        </span><span class="s2">"restaurant34"</span><span class="w">
      </span><span class="p">]</span><span class="w">
    </span><span class="p">}</span><span class="w">
  </span><span class="p">],</span><span class="w">
...
<table class="reset-td-br-1 reset-td-br-2" aria-label="Troubleshooting">
  ...
  <tbody>
    ...
    <tr>
      <td><code class="language-plaintext highlighter-rouge">item-not-found</code></td>
