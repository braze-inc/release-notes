<div id='api_hmpmiepbpdvp' class='api_div' data-search-keywords='edit multiple catalog items message errors id parameters parameter_values'>
...
<blockquote>
  <p>Use this endpoint to edit multiple existing items in your catalog.</p>
</blockquote>

<p>Each request can support up to 50 items. This endpoint is asynchronous.</p>

<div class="api_reference postman"><a href="https://documenter.getpostman.com/view/4689407/SVYrsdsG?version=latest#03f3548e-4139-4f60-812d-7e1a695a738a" class="seeme">See me in Postman</a></div>
...
35
36
</pre></td><td class="rouge-code"><pre>curl --location --request PATCH 'https://rest.iad-03.braze.com/catalogs/restaurants/items' \
