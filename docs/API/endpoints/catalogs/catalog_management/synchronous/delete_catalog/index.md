<div id='api_iqjvtztmgsrh' class='api_div' data-search-keywords='delete catalog message errors id parameters parameter_values'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">catalogs.delete</code> permission.</p>
