<div id='api_bwqqzwxzjbeo' class='api_div' data-search-keywords='list sdk authentication keys keys id rsa_public_key description is_primary'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">sdk_authentication.keys</code> permission.</p>
