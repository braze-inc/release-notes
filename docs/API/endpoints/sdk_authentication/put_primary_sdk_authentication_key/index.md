<div id='api_cujerjlulbhz' class='api_div' data-search-keywords='set primary sdk authentication key app_id key_id keys id rsa_public_key description is_primary'>
...
<blockquote>
  <p>Use this endpoint to set an SDK Authentication key as the primary key for your app.</p>
</blockquote>

<h2 id="prerequisites">Prerequisites</h2>

<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">sdk_authentication.primary</code> permission.</p>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Request parameters">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Required</td>
      <td>String</td>
      <td>The ID of the SDK Authentication key to mark as primary.</td>
    </tr>
  </tbody>
</table>
...
6
7
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> PUT <span class="s1">'https://rest.iad-01.braze.com/app_group/sdk_authentication/primary'</span> <span class="se">\</span>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Response parameters">
  ...
  <tbody>
    <tr>
      ...
      <td>Array</td>
      <td>Array of all SDK Authentication key objects.</td>
    </tr>
    <tr>
