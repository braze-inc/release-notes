<div id='api_kwwccckdgyyy' class='api_div' data-search-keywords='create sdk authentication key app_id rsa_public_key_str description make_primary id'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">sdk_authentication.create</code> permission.</p>
