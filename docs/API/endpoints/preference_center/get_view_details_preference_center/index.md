<div id='api_zsisawxjckqt' class='api_div' data-search-keywords='view details for preference center name preference_center_api_id created_at updated_at preference_center_title preference_center_page_html confirmation_page_html redirect_page_html preference_center_options state'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">preference_center.get</code> permission.</p>
