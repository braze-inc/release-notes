<div id='api_ruwqahoxsoqd' class='api_div' data-search-keywords='generate preference center url preference_center_url'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics#rest-api-key-permissions">API key</a> with the <code class="language-plaintext highlighter-rouge">preference_center.user.get</code> permission.</p>
