<div id='api_phvyqyzxlazk' class='api_div' data-search-keywords='prerequisites external_send_id trigger_properties recipient user_alias external_user_id attributes dispatch_id status metadata campaign_api_id received_at enqueued_at executed_at sent_at processed_at delivered_at bounced_at aborted_at reason'>
