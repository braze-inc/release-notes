<div id='api_rxocdtafhucz' class='api_div' data-search-keywords='delete scheduled api-triggered campaigns campaign_id schedule_id'>
...
6
7
</pre></td><td class="rouge-code"><pre>curl --location --request POST 'https://rest.iad-01.braze.com/campaigns/trigger/schedule/delete' \
