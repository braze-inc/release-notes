<div id='api_heoxxrnxtvtv' class='api_div' data-search-keywords='replace object relationship rel_kind related_type_name related_external_id anchor attributes object_relationship to_data_object type_name external_id name'>
...
<blockquote>
  <p>Use this endpoint to create or replace an object relationship.</p>
</blockquote>
...
<p>This example replaces the <code class="language-plaintext highlighter-rouge">subaccount</code> relationship between <code class="language-plaintext highlighter-rouge">acct-123</code> and <code class="language-plaintext highlighter-rouge">acct-456</code>, overwriting any attributes previously stored on it.</p>
...
9
10
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> PUT <span class="s1">'https://rest.iad-01.braze.com/data_objects/objects/account/acct-123/object_relationships'</span> <span class="se">\</span>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Replace object relationship response parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Created or replaced relationship record</td>
    </tr>
    <tr>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Replace object relationship errors">
  <thead>
    <tr>
      <th>Status</th>
      <th>Cause</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Relationship or endpoint objects not found (<code class="language-plaintext highlighter-rouge">data-object-relationship-not-found</code>)</td>
      <td>Confirm both objects and related type names exist in the workspace.</td>
    </tr>
    <tr>
