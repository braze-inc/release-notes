<div id='api_rzqgxxtcgugn' class='api_div' data-search-keywords='create object relationship rel_kind related_type_name related_object_id anchor attributes object_relationship to_data_object type_name object_id name'>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Create object relationship response parameters">
  ...
  <tbody>
    ...
    <tr>
      <td><code class="language-plaintext highlighter-rouge">object_relationship.to_data_object.object_id</code></td>
      <td>Conditional</td>
      <td>String</td>
      <td>Related object identifier</td>
    </tr>
    ...
    <tr>
      <td><code class="language-plaintext highlighter-rouge">object_relationship.from_data_object.object_id</code></td>
      <td>Conditional</td>
      <td>String</td>
      <td>Related object identifier</td>
    </tr>
