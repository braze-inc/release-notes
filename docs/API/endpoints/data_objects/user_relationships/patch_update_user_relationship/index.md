<div id='api_kqdhzhfxamsa' class='api_div' data-search-keywords='update user relationship braze_id rel_kind attributes role user_relationship type_name external_id user'>
...
<blockquote>
  <p>Use this endpoint to merge attributes into an existing user relationship.</p>
</blockquote>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Update user relationship path parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Update user relationship request parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
...
7
    ...
    </span><span class="nl">"role"</span><span class="p">:</span><span class="w"> </span><span class="s2">"billing_admin"</span><span class="w">
...
<p>This example changes the <code class="language-plaintext highlighter-rouge">role</code> attribute on the existing <code class="language-plaintext highlighter-rouge">account_user</code> relationship to <code class="language-plaintext highlighter-rouge">billing_admin</code>, leaving the relationship’s other attributes unchanged.</p>
...
9
10
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> PATCH <span class="s1">'https://rest.iad-01.braze.com/data_objects/objects/account/acct-123/users'</span> <span class="se">\</span>
...
9
    ...
    </span><span class="nl">"attributes"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nl">"role"</span><span class="p">:</span><span class="w"> </span><span class="s2">"billing_admin"</span><span class="w"> </span><span class="p">}</span><span class="w">
  </span><span class="p">}</span><span class="w">
</span><span class="p">}</span><span class="w">
</span></pre></td></tr></tbody></table></code></pre></div></div>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Update user relationship response parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Updated user relationship record</td>
    </tr>
    <tr>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Update user relationship errors">
  <thead>
    <tr>
      <th>Status</th>
      <th>Cause</th>
