<div id='api_ckzyswrsejol' class='api_div' data-search-keywords='replace data object attributes name data_object type_name external_id'>
...
<blockquote>
  <p>Use this endpoint to create or replace a data object with full-attribute replacement semantics.</p>
</blockquote>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Replace data object path parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Replace data object request parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Full object attributes. Omitted fields are cleared</td>
    </tr>
    <tr>
...
5
    ...
    </span><span class="nl">"name"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Updated Account"</span><span class="w">
...
<p>This example replaces the stored attributes on <code class="language-plaintext highlighter-rouge">acct-123</code> with the ones in the payload. If no record with that identifier exists, this request creates it.</p>
...
7
8
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> PUT <span class="s1">'https://rest.iad-01.braze.com/data_objects/objects/account/acct-123'</span> <span class="se">\</span>
...
<p>The status code <code class="language-plaintext highlighter-rouge">200</code> could return the following response body. This endpoint returns <code class="language-plaintext highlighter-rouge">200</code> whether the request created or replaced the object.</p>
...
7
    ...
    </span><span class="nl">"attributes"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nl">"name"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Updated Account"</span><span class="w"> </span><span class="p">}</span><span class="w">
  </span><span class="p">}</span><span class="w">
</span><span class="p">}</span><span class="w">
</span></pre></td></tr></tbody></table></code></pre></div></div>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Replace data object response parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Created or replaced data object record</td>
    </tr>
    <tr>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Replace data object errors">
  <thead>
    <tr>
      <th>Status</th>
      <th>Cause</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Record limit reached (<code class="language-plaintext highlighter-rouge">data-object-record-limit-exceeded</code>) when this request would create a new object</td>
