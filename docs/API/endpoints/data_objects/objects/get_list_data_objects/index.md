<div id='api_ptegvvmuzelo' class='api_div' data-search-keywords='list data objects type_name search_term limit offset items external_id attributes name industry total_count has_more next_offset'>
...
<blockquote>
  <p>Use this endpoint to list objects for a specific data object type.</p>
</blockquote>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="List data objects path parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
...
<p>The following table lists and describes the query parameters for the <code class="language-plaintext highlighter-rouge">/data_objects/objects/{type_name}</code> endpoint.</p>

<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="List data objects query parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Optional</td>
      <td>String</td>
      <td>Substring filter on object identifier</td>
    </tr>
    <tr>
...
6
  ...
  </span><span class="nl">"search_term"</span><span class="p">:</span><span class="w"> </span><span class="s2">"acct"</span><span class="p">,</span><span class="w">
...
<p>This example lists the <code class="language-plaintext highlighter-rouge">account</code> records matching the search term <code class="language-plaintext highlighter-rouge">acct</code>, returning the first page of results.</p>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><table class="rouge-table"><tbody><tr><td class="rouge-gutter gl"><pre class="lineno">1
2
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> GET <span class="s1">'https://rest.iad-01.braze.com/data_objects/objects/account?search_term=acct&amp;limit=100&amp;offset=0'</span> <span class="se">\</span>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="List data objects response parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Array</td>
      <td>List of data object records</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Object attributes keyed by field name</td>
    </tr>
    <tr>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="List data objects errors">
  <thead>
    <tr>
      <th>Status</th>
      <th>Cause</th>
