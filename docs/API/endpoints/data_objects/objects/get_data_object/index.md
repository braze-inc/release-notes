<div id='api_nqljgzdvdeeo' class='api_div' data-search-keywords='get data object type_name external_id data_object attributes name industry'>
...
<blockquote>
  <p>Use this endpoint to return one data object.</p>
</blockquote>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Get data object path parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
...
<p>This example retrieves the <code class="language-plaintext highlighter-rouge">acct-123</code> account record and its stored attributes.</p>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><table class="rouge-table"><tbody><tr><td class="rouge-gutter gl"><pre class="lineno">1
2
</pre></td><td class="rouge-code"><pre>curl <span class="nt">--location</span> <span class="nt">--request</span> GET <span class="s1">'https://rest.iad-01.braze.com/data_objects/objects/account/acct-123'</span> <span class="se">\</span>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3 reset-td-br-4" aria-label="Get data object response parameters">
  <thead>
    <tr>
      <th>Parameter</th>
      <th>Required</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Required</td>
      <td>Object</td>
      <td>Returned data object record</td>
    </tr>
    <tr>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Get data object errors">
  <thead>
    <tr>
      <th>Status</th>
      <th>Cause</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Type not found (<code class="language-plaintext highlighter-rouge">data-object-type-not-found</code>) or object not found (<code class="language-plaintext highlighter-rouge">data-object-not-found</code>)</td>
