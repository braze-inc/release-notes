<div id='api_xzmpgxbyjtqu' class='api_div' data-search-keywords='upload an asset to the media library asset_url name asset_file message error_code meta new_assets size url ext errors error dashboard_url'>
...
<table class="reset-td-br-1 reset-td-br-2 reset-td-br-3" aria-label="Processing errors">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>400</td>
      <td>The image file is corrupted or could not be decoded. The <code class="language-plaintext highlighter-rouge">meta</code> object includes <code class="language-plaintext highlighter-rouge">file_name</code>.</td>
    </tr>
    <tr>
