<div id='api_bicrnprnblgu' class='api_div' data-search-keywords='list available content blocks count content_blocks content_block_id name content_type liquid_tag inclusion_count created_at last_edited tags'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics">API key</a> with the <code class="language-plaintext highlighter-rouge">content_blocks.list</code> permission.</p>
