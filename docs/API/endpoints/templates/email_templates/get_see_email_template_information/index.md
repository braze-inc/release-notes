<div id='api_qfvyvmzzxdgc' class='api_div' data-search-keywords='see email template information email_template_id template_name description subject preheader body plaintext_body should_inline_css tags created_at updated_at'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics">API key</a> with the <code class="language-plaintext highlighter-rouge">templates.email.info</code> permission.</p>
