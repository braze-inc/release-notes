<div id='api_ldnqtarohtju' class='api_div' data-search-keywords='create email template template_name subject body plaintext_body preheader tags should_inline_css email_template_id message'>
...
<p>To use this endpoint, you’ll need an <a href="/docs/api/basics">API key</a> with the <code class="language-plaintext highlighter-rouge">templates.email.create</code> permission.</p>
