...
3. Give this environment a name (for example, "Braze API Requests") and add keys for `instance_url` and `api_key` with values corresponding to your [Braze instance](https://www.braze.com/docs/developer_guide/rest_api/basics/#endpoints) and [Braze REST API Key](https://www.braze.com/docs/api/api_key/).
4. Click **Save**.
...
![Adding variables for API key and instance URL to the Braze REST API environment in Postman.](https://www.braze.com/docs/assets/img_archive/postman_variable.png?f904b85abb0409eef1127f3873032097)
...
![Body tab when editing a POST User Track request in Postman](https://www.braze.com/docs/assets/img_archive/postman_post.png?b6561a7fe5b93b806424e53c3dc5de35)
...
![Params tab when editing a GET Query List of Unsubscribed Email Addresses request in Postman.](https://www.braze.com/docs/assets/img_archive/postman_get.png?59d0b040b2abdde47a256db7f97e5bfb)
...
![Example body response data from a POST request with a status of 201 Created and response time of 269 milliseconds.](https://www.braze.com/docs/assets/img_archive/postman_response.png?31ec629f1a8c1d488188bd7da60b9433)
