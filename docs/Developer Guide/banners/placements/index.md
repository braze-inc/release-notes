...
For method signatures and full details, see the [Braze SDK reference documentation](https://www.braze.com/docs/developer_guide/references).
...
You'll need to [add custom properties](https://www.braze.com/docs/user_guide/channels/banners/create_a_banner/#custom-properties) to your Banner campaign. Additionally, these are the minimum SDK versions required to access custom properties:
