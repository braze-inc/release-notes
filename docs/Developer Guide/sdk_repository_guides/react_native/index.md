...
- **Push notifications**: Permission prompts, token registration, payload listeners (see platform notes in **Native setup**)
...
1. Install the npm package (in **Installation**).
...
> **Source of truth:** Step-by-step screens, Gradle/CocoaPods changes, and the full list of Android XML keys are in the [Braze React Native developer guide](https://www.braze.com/docs/developer_guide/sdk_integration/?sdktab=react%20native). The snippets in this section are minimal examples.
