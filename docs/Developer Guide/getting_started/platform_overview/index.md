...
<div class='swiper swiper-container' id='gallery_yswgdlbkzfmn'><div class='swiper-wrapper'>
...
<script type='text/javascript'>let swiper = new Swiper('#gallery_yswgdlbkzfmn', {slidesPerView: 'auto',spaceBetween: 30,loop: false, pagination: { el: '.swiper-pagination', clickable: true }, navigation: { nextEl: '.swiper-button-next', prevEl: '.swiper-button-prev'}});</script>
