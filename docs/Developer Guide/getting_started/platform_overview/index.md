...
<div class='swiper swiper-container' id='gallery_ujsxlcivjvdv'><div class='swiper-wrapper'>
...
<script type='text/javascript'>document.addEventListener('DOMContentLoaded',function(){new Swiper('#gallery_ujsxlcivjvdv', {slidesPerView: 'auto',spaceBetween: 30,loop: false, pagination: { el: '.swiper-pagination', clickable: true }, navigation: { nextEl: '.swiper-button-next', prevEl: '.swiper-button-prev'}});});</script>
