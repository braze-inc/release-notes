...
1. Implement the `BrazeInAppMessageUIDelegate` delegate as described in our [iOS in-app message UI tutorial](https://braze-inc.github.io/braze-swift-sdk/tutorials/braze/c1-inappmessageui).
