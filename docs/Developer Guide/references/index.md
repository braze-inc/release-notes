...
For mirrored repository README content in docs, see [Repository guides](https://www.braze.com/docs/developer_guide/sdk_repository_guides).
...
1. Create a new [workspace](https://www.braze.com/docs/user_guide/get_started/workspaces) and note the Braze API identifier key.<br><br>
...
![Screenshot related to building "hello braze".](https://www.braze.com/docs/assets/img_archive/hello_appboy.png?6a24a92e98dc23be7df4f1b6ce39eef5)<br><br>
...
1. Create a new [workspace](https://www.braze.com/docs/user_guide/get_started/workspaces) and note the app identifier API key and endpoint.
