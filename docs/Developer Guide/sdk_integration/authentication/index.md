...
![Braze SDK Authentication settings showing Disabled, Optional, and Required enforcement options.](https://www.braze.com/docs/assets/img/sdk-auth-settings.png?57ca6f4602ca213f2fc891c8c459c6f2)
...
![A chart showing the number of instances of authentication errors. Also shown are the total number of errors, error type, and adjustable date range.](https://www.braze.com/docs/assets/img/sdk-auth-analytics.png?c6dc9b578383a57c21f77f032808930e){: style="max-width:80%"}
