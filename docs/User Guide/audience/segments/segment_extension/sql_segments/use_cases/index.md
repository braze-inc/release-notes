<div id='api_jtoisgiuhjwo' class='api_div' data-search-keywords='select users by how many times an event has occurred event'>
...
<div id='api_hwavbksrpwvt' class='api_div' data-search-keywords='select users that performed an action and sum up a property value property'>
...
<div id='api_vsmrfjlgqrvx' class='api_div' data-search-keywords='select users based on how many times an event occurred in a time range event, time range'>
...
<div id='api_bvicvmqdaina' class='api_div' data-search-keywords='select users that recorded at least one event across multiple time ranges event, time range'>
...
<div id='api_bxkgoedrgyik' class='api_div' data-search-keywords='select any purchase with certain properties purchase, property'>
...
<div id='api_qgtqlnrverex' class='api_div' data-search-keywords='select users that were sent a message that wasn’t delivered message, delivery'>
...
<div id='api_dolxiebqpczq' class='api_div' data-search-keywords='find all sms messages that were sent but didn’t reach the carrier because of queue overflow message, carrier'>
...
<div id='api_klxovytvxmjf' class='api_div' data-search-keywords='select users that made any purchase with a property array containing a specific value purchase, property'>
...
<div id='api_nfkfzekxjzts' class='api_div' data-search-keywords='find all users that had multiple 30003 errors and 0 deliveries error, delivery'>
...
<div id='api_utvzhnfbqkmd' class='api_div' data-search-keywords='find users with specific event properties and event counts in a time range event, property, time range'>
...
<div id='api_cytbgpewvcjg' class='api_div' data-search-keywords='select users whose most recent session was on a specific device model session, device'>
...
<div id='api_bqgynfpqrfuk' class='api_div' data-search-keywords='find users that selected the second button of an in-app message in a specific time range time range'>
...
<div id='api_egcyxvvkhjun' class='api_div' data-search-keywords='find users that purchased in each of the last three calendar months purchase, time range'>
...
<div id='api_varhxpfzdeoo' class='api_div' data-search-keywords='select users that completed a custom event with a specific property when property is an integer event, property'>
...
<div id='api_ifcoexblcdxy' class='api_div' data-search-keywords='find the average number of emails a user receives daily message'>
...
<div id='api_oqvzmfvuzfsj' class='api_div' data-search-keywords='find the average number of emails a user receives weekly message'>
