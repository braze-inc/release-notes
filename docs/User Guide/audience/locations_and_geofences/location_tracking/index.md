...
You can also use the [`users/track` endpoint](https://www.braze.com/docs/api/endpoints/user_data/post_user_track) in our API to update the [`current_location`](https://www.braze.com/docs/api/objects_filters/user_attributes_object#braze-user-profile-fields) standard attribute. An example is:
