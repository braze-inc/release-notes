...
If you have fewer qualifying users, broaden your prediction audience or extend the event window before you build the prediction. For setup steps, see [Create an event prediction](https://www.braze.com/docs/user_guide/brazeai/predictive_suite/predictive_events/creating_an_event_prediction).
