...
The data extensions and SQL queries are configured as part of [Set up your Decisioning Studio Go agent](https://www.braze.com/docs/user_guide/brazeai/decisioning_studio/decisioning_studio_go/setup/).
...
- [Set up your Decisioning Studio Go agent](https://www.braze.com/docs/user_guide/brazeai/decisioning_studio/decisioning_studio_go/setup/)
