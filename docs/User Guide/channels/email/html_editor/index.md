...
Then, you can **Copy preview link** to generate and copy a shareable preview link that shows what the email will look like for a random user. For more information, see [Shareable preview](https://www.braze.com/docs/user_guide/messaging/governance/shareable_preview).
...
- Email body is over 400&nbsp;KB
  - Aim for [less than 102&nbsp;KB](https://www.braze.com/docs/user_guide/channels/email/best_practices/email_styling#email-size) to avoid clipping.
...
You can also set the campaign's duration, specify [Quiet hours](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/quiet_hours), and set [frequency capping](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/frequency_capping#about-frequency-capping) rules.
