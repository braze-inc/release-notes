...
The recipient's email client, not Braze, controls how alt text displays. For details on this behavior across clients like Gmail, Outlook, and Apple Mail, refer to [How email clients display alt text](https://www.braze.com/docs/user_guide/messaging/messaging_fundamentals/accessibility#how-email-clients-display-alt-text).
...
For more information on how Braze handles duplicate email addresses and deduplication, see the [Email FAQ](https://www.braze.com/docs/user_guide/channels/email/faq#what-happens-when-an-email-is-sent-out-and-multiple-profiles-have-the-same-email-address).
