...
> Braze surveys collect feedback in in-app messages that you can analyze and use in follow-up messaging. To start a survey, select **Survey** as your message type on the message composition page before opening the [drag-and-drop editor](https://www.braze.com/docs/user_guide/channels/in_app_messages/drag_and_drop).
