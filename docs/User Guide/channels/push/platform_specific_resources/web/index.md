...
Web push works the same way app push notifications operate on your phone. For more information on composing a web push, check out [Create a push notification](https://www.braze.com/docs/user_guide/channels/push/create_a_push_message).
