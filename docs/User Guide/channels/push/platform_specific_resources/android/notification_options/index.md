...
![First, create your Android push campaign, then look to the top of the Compose tab for the Notification Channel dropdown.](https://www.braze.com/docs/assets/img_archive/notification_channel_dropdown.png?6033af9998755b1005b31379fda680c9){: style="max-width:60%;"}
...
![To add a Notification ID to your Notification Channel, click Manage Notification Channel in the Notification Channel dropdown menu and fill out the required fields. Notification Channels must be defined on the app before they can be used in the Braze platform.](https://www.braze.com/docs/assets/img_archive/notification_channels.png?89bed1ea0b35b463ac18739800390e45){: style="max-width:80%;" }
