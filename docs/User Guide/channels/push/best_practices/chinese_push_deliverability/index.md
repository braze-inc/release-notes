...
To target your in-app message to users on specific Chinese OEM devices, use the **Device Model** or **Device OS** [segmentation filters](https://www.braze.com/docs/user_guide/audience/segments/segmentation_filters):
...
For more information on regex behavior in Braze and pattern testing, see [Regular expressions](https://www.braze.com/docs/user_guide/audience/segments/regex).
...
For details on where to find device metadata in profiles, see [User profiles](https://www.braze.com/docs/user_guide/audience/manage_audience/user_profiles). For details on testing segment logic, see [Create a segment](https://www.braze.com/docs/user_guide/audience/segments/creating_a_segment#testing-segments).
