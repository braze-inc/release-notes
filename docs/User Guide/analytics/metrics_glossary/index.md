...
<div id='api_ibqgszdjfoeq' class='api_div' data-search-keywords='amp clicks email'>
...
<div id='api_jojykpamcywv' class='api_div' data-search-keywords='amp opens email'>
...
<div id='api_rcpwadwioklk' class='api_div' data-search-keywords='audience all'>
...
<div id='api_jorniyjhmyyp' class='api_div' data-search-keywords='bounces email, web push, ios push'>
...
<div id='api_tkblqsufrgza' class='api_div' data-search-keywords='body click ios push, android push'>
...
<div id='api_avtrcvkeolxp' class='api_div' data-search-keywords='body clicks in-app message'>
...
<div id='api_ekdbdkndoxif' class='api_div' data-search-keywords='button 1 clicks in-app message'>
...
<div id='api_yvzoocvzirdm' class='api_div' data-search-keywords='button 2 clicks in-app message'>
...
<div id='api_dpzzblftsvon' class='api_div' data-search-keywords='campaign analytics feature flags the performance of the message across various channels. the metrics shown depend on the selected messaging channel, and whether the feature flag experiment is a multivariate test.'>
...
<div id='api_kghofjuxpgwc' class='api_div' data-search-keywords='choices submitted in-app message'>
...
<div id='api_sjvfrulidiki' class='api_div' data-search-keywords='click-to-open rate email'>
...
<div id='api_mnqcxmduwhsa' class='api_div' data-search-keywords='rcs confirmed deliveries or sms confirmed deliveries sms/mms, rcs'>
...
<div id='api_eyvzzpwcaojj' class='api_div' data-search-keywords='confidence content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, whatsapp'>
...
<div id='api_gmpiibatuxko' class='api_div' data-search-keywords='confirmation page button in-app message'>
...
<div id='api_qnwdnwytpbtb' class='api_div' data-search-keywords='confirmation page dismissals in-app message'>
...
<div id='api_wscrvcqvbtyn' class='api_div' data-search-keywords='conversions (b, c, d) content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms'>
...
<div id='api_iltvdtcipmss' class='api_div' data-search-keywords='total conversions in-app message'>
...
<div id='api_gidrmdxyzbvh' class='api_div' data-search-keywords='close message in-app message'>
...
<div id='api_wysmmvhtyrgp' class='api_div' data-search-keywords='conversion rate content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms'>
...
<div id='api_mvaeltfgdrgf' class='api_div' data-search-keywords='conversion window all'>
...
<div id='api_zlzupfnodmcm' class='api_div' data-search-keywords='deliveries email, web push, ios push, android push, whatsapp'>
...
<div id='api_allzphwbwtun' class='api_div' data-search-keywords='rcs delivery failures or sms delivery failures sms/mms'>
...
<div id='api_fsonozaptuzu' class='api_div' data-search-keywords='delivery failures rcs'>
...
<div id='api_zsidslcukcpc' class='api_div' data-search-keywords='failed delivery rate sms/mms'>
...
<div id='api_rwnkzgvywpaz' class='api_div' data-search-keywords='direct opens ios push'>
...
<div id='api_qhtioumspmqh' class='api_div' data-search-keywords='emailable email'>
...
<div id='api_zbfwmbbcmjqa' class='api_div' data-search-keywords='errors webhook'>
...
<div id='api_uelpmkscqhgw' class='api_div' data-search-keywords='estimated real opens email'>
...
<div id='api_ugvtrxqrdqqy' class='api_div' data-search-keywords='failures whatsapp'>
...
<div id='api_ilnkcalvtgcj' class='api_div' data-search-keywords='feature flag experiment performance feature flags performance metrics for the message in a feature flag experiment. the specific metrics shown will vary depending on the messaging channel, and whether or not the experiment was a multivariate test.'>
...
<div id='api_ujpbxzjcywik' class='api_div' data-search-keywords='hard bounce email'>
...
<div id='api_oolbvwspwdar' class='api_div' data-search-keywords='help sms/mms, rcs'>
<h2 id="help">Help</h2>
...
<div id='api_nefdmakpnxch' class='api_div' data-search-keywords='influenced opens ios push, android push'>
...
<div id='api_htfitxepqyxj' class='api_div' data-search-keywords='lifetime revenue content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, line'>
...
<div id='api_tcoctuscigjp' class='api_div' data-search-keywords='lifetime value per user content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, line'>
...
<div id='api_azdmwaqealki' class='api_div' data-search-keywords='average daily revenue content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, line'>
...
<div id='api_mfwiprdcxlxc' class='api_div' data-search-keywords='daily purchases content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, line'>
...
<div id='api_xncbnguijidn' class='api_div' data-search-keywords='daily revenue per user content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, line'>
...
<div id='api_wkfsntlmsbzw' class='api_div' data-search-keywords='machine opens email'>
...
<div id='api_cqbjxwijxusc' class='api_div' data-search-keywords='opens web push, ios push, android push'>
...
<div id='api_rctqynagmpsg' class='api_div' data-search-keywords='opt-out sms/mms, rcs'>
...
<div id='api_murvlyxupumm' class='api_div' data-search-keywords='other opens email'>
...
<div id='api_yhmzuibmvrim' class='api_div' data-search-keywords='pending retry email'>
...
<div id='api_wrkdfnrylutp' class='api_div' data-search-keywords='primary conversions (a) or primary conversion event content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, whatsapp'>
...
<div id='api_ykxhwkwwpjmf' class='api_div' data-search-keywords='reads whatsapp'>
...
<div id='api_vykuflfsixng' class='api_div' data-search-keywords='read rate whatsapp'>
...
<div id='api_zjejwxmgbafm' class='api_div' data-search-keywords='received email, content cards, in-app message, web push, ios push, android push, sms/mms, whatsapp'>
...
<div id='api_lohlbpgbifuz' class='api_div' data-search-keywords='rcs rejections or sms rejections sms/mms, rcs'>
...
<div id='api_odkafdjcgctt' class='api_div' data-search-keywords='revenue email'>
...
<div id='api_qhrpfedpdhxh' class='api_div' data-search-keywords='sent sms/mms'>
<h2 id="sent">Sent</h2>
...
<div id='api_dhycjtvxmhvz' class='api_div' data-search-keywords='sends content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, rcs, whatsapp, line'>
...
<div id='api_vzclbucfkpec' class='api_div' data-search-keywords='messages sent content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, whatsapp, line'>
...
<div id='api_rbktfitwtkyx' class='api_div' data-search-keywords='sends to carrier sms/mms'>
...
<div id='api_shangvsudfys' class='api_div' data-search-keywords='soft bounce email'>
...
<div id='api_yfipdpwsgoqe' class='api_div' data-search-keywords='spam email'>
<h2 id="spam">Spam</h2>
...
<div id='api_gbcatdlqfsqx' class='api_div' data-search-keywords='survey page dismissals in-app message'>
...
<div id='api_qfetvepybagk' class='api_div' data-search-keywords='survey submissions in-app message'>
...
<div id='api_mnpnpdkwlcey' class='api_div' data-search-keywords='total clicks email, content cards, sms/mms, line'>
...
<div id='api_sqyahgillwkw' class='api_div' data-search-keywords='total dismissals content cards, banners'>
...
<div id='api_lbyjudepctpq' class='api_div' data-search-keywords='total impressions in-app message, content cards'>
...
<div id='api_cspntoawobmt' class='api_div' data-search-keywords='total opens email, ios push, android push, web push, line'>
...
<div id='api_tuwxkjbivhov' class='api_div' data-search-keywords='total revenue content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, whatsapp'>
...
<div id='api_kirzpnmrflmn' class='api_div' data-search-keywords='unique clicks email, content cards, line'>
...
<div id='api_sbpuzxkfmwde' class='api_div' data-search-keywords='unique dismissals content cards'>
...
<div id='api_tjdxnptlfwhw' class='api_div' data-search-keywords='unique daily impressions content cards, banners'>
...
<div id='api_jpzzanwprhul' class='api_div' data-search-keywords='unique impressions in-app message, content cards'>
...
<div id='api_mzroxtzpbmfk' class='api_div' data-search-keywords='unique opens email, line'>
...
<div id='api_jtmeusbxgrkr' class='api_div' data-search-keywords='unique recipients email, in-app message, web push, ios push, android push, webhook, sms/mms, rcs, whatsapp, line'>
...
<div id='api_jqkeoiafaoqv' class='api_div' data-search-keywords='unsubscribers or unsub email'>
...
<div id='api_lmmualfifawl' class='api_div' data-search-keywords='unsubscribes email'>
...
<div id='api_wcgjucqybshi' class='api_div' data-search-keywords='variation content cards, email, in-app message, web push, ios push, android push, webhook, sms/mms, whatsapp'>
