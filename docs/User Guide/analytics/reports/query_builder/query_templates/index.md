...
| Email performance by country | This report shows the following metrics for each country: sends, indirect open rate, and direct open rate. Country is the country of the user at the time of push send. <br><br> ![Screenshot related to email templates.](https://www.braze.com/docs/assets/img_archive/query_builder_q3.png?dea9ce73cf0e73331d8fb053852c791e) |
...
| Query name | Description | 
| --- | --- | 
| Device carriers | The number of users per device carrier, such as Verizon and T-Mobile. <br><br> ![Screenshot related to mobile templates.](https://www.braze.com/docs/assets/img_archive/device_carriers.png?7ffa6a60e466e7f6aa4646621f76be83){: style="max-width:50%;"} |
| Device models | The number of users per device model, such as iPhone 15 Pro and Pixel 7. <br><br> ![Screenshot related to mobile templates.](https://www.braze.com/docs/assets/img_archive/device_models.png?60ea1b8692a03ef5a3963b7d20404a8c){: style="max-width:50%;"} |
| Device operating systems | The number of users per operating system, such as 17.4 and Android 14. <br><br> ![Screenshot related to mobile templates.](https://www.braze.com/docs/assets/img_archive/os_version.png?99ab2798b11159aeabee4ee50d9b500b){: style="max-width:50%;"} |
| Device screen resolutions | The number of users per device screen resolution, such as 1179x2556 and 750x1334. <br><br> ![Screenshot related to mobile templates.](https://www.braze.com/docs/assets/img_archive/device_screen_resolutions.png?9d78e23debdedceb56d8e3c4ad9b3c52){: style="max-width:40%;"} |
| SMS Error Codes | This report shows the error type and number of errors for each SMS error code. <br><br>![Screenshot related to mobile templates.](https://www.braze.com/docs/assets/img_archive/sms_errors.png?da3a83c8e6a01db7405fcb2e3a3c4186){: style="max-width:50%;"} |
