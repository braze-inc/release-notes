...
> Analyze how your segments perform in Report Builder, and break down campaign or Canvas results by segment membership.

Report Builder supports **Segments** in rows and as a drilldown option. If **Segments** doesn't appear in your **Rows** or **Drilldown** dropdowns, this feature hasn't been enabled for your account.
...
Segment reporting is available only for segments with [analytics tracking](https://www.braze.com/docs/user_guide/analytics/tracking/segment_analytics_tracking) enabled. To select **Segments** in the **Rows** dropdown, you need the workspace-level ["View Dashboard Reports" permission](https://www.braze.com/docs/user_guide/administer/global/user_management/permissions).
...
For the full Report Builder workflow, see [Creating a report](https://www.braze.com/docs/user_guide/analytics/reports/report_builder#creating-a-report).
...
For more on how your rows and drilldown selections affect metrics, see [Metrics availability](https://www.braze.com/docs/user_guide/analytics/reports/report_builder#metrics-availability) in Report Builder.
