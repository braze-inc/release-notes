...
You can also specify an abort reason. The reason must be a string and cannot contain Liquid. The aborted send appears in [Messaging Observability](https://www.braze.com/docs/user_guide/analytics/dashboards/dashboard_builder/messaging_observability) with the outcome **Liquid abort**.
