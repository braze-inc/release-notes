...
For example, if the `message` event property in the example in the following section contains characters that could break the JSON format, add the `json_escape` filter like in this example:
