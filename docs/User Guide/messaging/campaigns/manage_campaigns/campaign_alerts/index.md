...
Looking for the same capability on a Canvas? Refer to [Custom Canvas alerts](https://www.braze.com/docs/user_guide/messaging/canvas/managing_canvases/custom_canvas_alerts).
