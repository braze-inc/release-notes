...
![Screenshot related to onboarding.](https://www.braze.com/docs/assets/img_archive/canvas_outline_onboarding.png?5be9a96dde4dd467c6a94303deb803d7){: style="max-width:90%;"}
...
![Upselling your subscriptions can also be encouraged through building and sending effective Canvases. For example, if you want to upgrade active users who are on a free version of your app, you can create an action-based Canvas to trigger when a customer has reached the custom event "3 hours streamed". Using a Message step, you can prompt these customers to sign up for your premium subscriptions.](https://www.braze.com/docs/assets/img_archive/canvas_outline_upsell.png?28eab2b190059a4c5c3a875e4cf7d95b){: style="max-width:90%;"}
...
![Screenshot related to abandoned carts.](https://www.braze.com/docs/assets/img_archive/canvas_outline_cart.png?2f49cc8341e6089b8b523f8316341616){: style="max-width:90%;"}
...
![You can use Canvases to educate customers on resources. For example, for airline businesses, you can create a Canvas that primes customers who have booked for travel in three days by scheduling a weekly email with their flight information and related airport FAQ.](https://www.braze.com/docs/assets/img_archive/canvas_outline_resource.png?8802023d815095e872b5c6e09511ae40){: style="max-width:90%;"}
