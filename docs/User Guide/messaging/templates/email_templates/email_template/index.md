...
You can also choose from predesigned Braze templates, create a new template, or edit an existing template (plain or [mobile responsive](https://www.braze.com/docs/releases/2018/may#mobile-responsive-email-templates)).
...
Then, you can **Copy preview link** to generate and copy a shareable preview link that shows what the email looks like for a random user. For more information, see [Shareable preview](https://www.braze.com/docs/user_guide/messaging/governance/shareable_preview).
