...
You can use `dispatch_id` as a [personalization tag](https://www.braze.com/docs/user_guide/messaging/design_and_edit/personalize/liquid/supported_personalization_tags), in [message engagement events](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events), or when you use [Segment](https://www.braze.com/docs/partners/data_and_analytics/customer_data_platform/segment/segment_for_currents), [Mixpanel](https://www.braze.com/docs/partners/data_and_analytics/analytics/mixpanel#supported-currents-events), or [Amplitude](https://www.braze.com/docs/partners/data_and_analytics/customer_data_platform/amplitude/amplitude_for_currents) for Currents.
