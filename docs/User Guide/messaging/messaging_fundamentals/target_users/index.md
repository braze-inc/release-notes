...
- To determine an accurate number for your reachable users, select [Calculate exact statistics](https://www.braze.com/docs/user_guide/audience/segments/measuring_segment_size#calculating-exact-statistics), as this will search through every user in your user base.
