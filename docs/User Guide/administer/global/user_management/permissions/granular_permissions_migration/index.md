...
2. If your company has automated user provisioning using SCIM or compliance tools that rely on [permission strings](https://www.braze.com/docs/scim_api_appendix/), update them to match the new granular structure. 
