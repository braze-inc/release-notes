...
**Credits Usage Overview** provides an overview of usage across all channels that use credits. You can see how you're pacing against your overall credit allotment, and find details about your active contract and your contract period.

This page displays if you're on a credits contract. The channels that use credits are shown in the **Credits contract overview**.
...
The **Credits Usage over Contract** graph shows your usage over the selected period of time. The granularity of this chart depends on your selected time frame. Export export options by selecting the menu in the top right corner of the chart.

![Credits Usage Overview dashboard with sections for credit usage, credit contract overview, and credit consumption over contract.](https://www.braze.com/docs/assets/img/app_settings/credit_usage_over_contract1.png?15142e2e895ecbaa65a7416ac2b17826){: style="max-width:70%;"}

## SMS, MMS, and RCS

**SMS/MMS/RCS Credits Usage** shows the usage breakdown for the SMS, MMS, and RCS channel. The columns in the data table generally require you to have purchased credits (though Braze still supports older billing models temporarily), and the **Credit ratio** and **Credits** columns indicate the respective country rate and consumed credits. Additionally, high-level tiles will indicate the total SMS and, when relevant, MMS consumption across the selected date range.

Filters are available allowing you to filter by **Country** or SMS and RCS type.

![SMS/MSS/RCS Credits Usage with tiles for high-level data and a section for consumption by account.](https://www.braze.com/docs/assets/img/app_settings/sms_credit_consumption2.png?2b8d22ea200883568aea4d4e43fa7b77){: style="max-width:70%;"}
...
![SMS/MMS/RCS Credits Usage table with null values.](https://www.braze.com/docs/assets/img/app_settings/sms_table_null3.png?6b5162a998e127691b28907e9cad5a45){: style="max-width:70%;"}
...
![WhatsApp Credits Usage with a tile for total credits consumed and a usage by account table.](https://www.braze.com/docs/assets/img/app_settings/whatsapp_credit_consumption4.png?48af6af1f0998b7c781ceb70eedbe7e3){: style="max-width:70%;"}
