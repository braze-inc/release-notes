...
![Message Credits Usage Overview dashboard with sections for credit usage, credit contract overview, and credit consumption over contract.](https://www.braze.com/docs/assets/img/app_settings/credit_usage_over_contract1.png?15142e2e895ecbaa65a7416ac2b17826){: style="max-width:70%;"}
