...
For full payload requirements, refer to [Table setup for Cloud Data Ingestion](https://www.braze.com/docs/user_guide/data/unification/cloud_ingestion/table_setup).
...
The error should no longer appear, and you should be able to update your notification preferences successfully. If you're still experiencing issues, [open a support ticket](https://www.braze.com/docs/user_guide/administer/personal/braze_support).
