...
Braze generates calculated metrics from three inputs: [SDK-tracked data](#minimum-integration) (for example, [session start and session end](https://www.braze.com/docs/developer_guide/analytics/tracking_sessions)), [message interaction data for non-SDK channels](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/event_glossary/message_engagement_events), and [Braze-derived reporting fields](https://www.braze.com/docs/user_guide/analytics/metrics_glossary). These values are generated by Braze services, so a user profile can include both SDK-tracked and Braze-generated data.
...
If you want a minimum integration and use mParticle, Segment, Tealium, or GTM, note the following:
...
To make the most out of Braze, our SDK integrators often implement the Braze SDKs and log [custom attributes](https://www.braze.com/docs/user_guide/data/activation/attributes/custom_attributes#set-custom-attributes), [custom events](https://www.braze.com/docs/user_guide/data/activation/events/custom_events#logging-custom-events) and [purchase events](https://www.braze.com/docs/user_guide/data/activation/events/purchase_events#log-purchase-events) that are pertinent to their business on top of the automatically collected data.
