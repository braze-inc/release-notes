...
<div id='api_chnvhpdcibll' class='api_div' data-search-keywords='user delete request events user delete request when a user is deleted by customer request app_group_id id time user_id'>
...
<div id='api_evybcidvvwcl' class='api_div' data-search-keywords='user orphan events user orphan when a user is orphaned, meaning the user is merged with another user’s profile app_group_id app_id device_id external_user_id id orphaned_by_id time user_id'>
