...
- [Custom push broadcast receiver for Android](https://www.braze.com/docs/releases/deprecations/custom_broadcast_receiver/)
- [Eclipse SDK setup](https://www.braze.com/docs/releases/deprecations/eclipse_setup_deprecated/)
- [TLS 1.0 and 1.1 deprecation](https://www.braze.com/docs/releases/deprecations/tls_deprecation/)
- [Twilio webhook integration](https://www.braze.com/docs/releases/deprecations/twilio/)
- [Apptimize partnership](https://www.braze.com/docs/releases/deprecations/apptimize/)
- [Grouparoo partnership](https://www.braze.com/docs/releases/deprecations/grouparoo)
- [Shopify `checkout.liquid` deprecation](https://www.braze.com/docs/releases/deprecations/shopify_checkout/)
...
Using a custom `BroadcastReceiver` for push notifications has been deprecated. Use [` subscribeToPushNotificationEvents()`](https://www.braze.com/docs/developer_guide/push_notifications/customization/?sdktab=android#android_using-a-callback-for-push-events) instead.
...
Support for the [Twilio webhook integration](https://www.braze.com/docs/partners/twilio/) has been discontinued as of January 31, 2020. If you wish to still access SMS services with Braze, see our [SMS documentation](https://www.braze.com/docs/user_guide/channels/sms_mms_and_rcs/).

### Apptimize partnership

**Support withdrawn**: August 2019

If you are currently using [Apptimize with Braze](https://www.braze.com/docs/releases/deprecations/apptimize), you will not experience a disruption of service. You can still set Apptimize custom attributes to Braze user profiles. However, no formal escalation support with the partner will be provided.

### Original in-app messages

**Support withdrawn:** February 2019<br>
**Replaced by**: [In-App Messaging](https://www.braze.com/docs/user_guide/channels/in_app_messages/traditional/)
...
**Replaced by**: [Firebase Cloud Messaging (FCM)](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/push_notifications/integration/standard_integration/#step-1-enable-firebase)
...
Customers that have not already migrated to [Firebase Cloud Messaging (FCM)](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/push_notifications/integration/standard_integration/#step-1-enable-firebase) may be affected by this change.
...
**Replaced by**: [Android Studio](https://www.braze.com/docs/developer_guide/platform_integration_guides/android/initial_sdk_setup/android_sdk_integration/#using-android-studio)
...
If you need assistance with your Eclipse integration prior to migration, contact [Support](https://www.braze.com/docs/support_contact/) for assistance.

### The Raw Event Stream (RES)

**Support withdrawn**: July 2018<br>
**Replaced by**: [Currents](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/)

The Raw Event Stream was the predecessor to [Currents](https://www.braze.com/docs/user_guide/data/distribution/braze_currents/) and was deprecated to make room for the future of Braze data.
