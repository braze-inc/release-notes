...
If you encounter duplicate user profiles, you can use our [bulk merging tool](https://www.braze.com/docs/user_guide/audience/manage_audience/merge_duplicate_users#bulk-merging) to help streamline your data. 
