...
![](https://www.braze.com/docs/assets/img/grouparoo/add-app.png?453f2e5b52600f06179ae6036ba7f1d5)
...
![Example property mapping fields. Grouparoo userID is set to map to external_id. email, firstName, and lastName are set as equivalent "email", "first_name", and "last_name" grouparoo fields.](https://www.braze.com/docs/assets/img/grouparoo/mapping.png?2e18b0e359d19d103b104dd2d32de598){: style="max-width:80%;"}
...
![Under "Braze Subscription Groups" in the Grouparoo destination configuration window, the "High value with recent automotive purchase" Grouparoo group will be added to the "High value with recent automotive purchase" Braze subscription group.](https://www.braze.com/docs/assets/img/grouparoo/lists.png?966c942f75f89635a4dea87d784aa6df){: style="max-width:80%;"}
