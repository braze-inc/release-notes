...
[Canvas threshold alerts](https://www.braze.com/docs/user_guide/messaging/canvas/managing_canvases/canvas_threshold_alerts) now support percentage thresholds based on the previous seven days. Combine percentage and volume rules with AND or OR logic to identify unexpected changes in Canvas entries or sends.
